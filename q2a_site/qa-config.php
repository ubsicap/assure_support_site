...
/*
	...
	define('QA_MYSQL_HOSTNAME', getenv('Q2A_DB_HOSTNAME'));
	define('QA_MYSQL_USERNAME', getenv('Q2A_DB_USER'));
	define('QA_MYSQL_PASSWORD', getenv('Q2A_DB_PASSWORD'));
	define('QA_MYSQL_DATABASE', getenv('Q2A_DB_NAME'));
	*/
