<?php
/*
	Paratext Theme for Question2Answer Package
	Copyright (C) 2022 Paratext <http://www.paratext.org>

	File:           qa-theme.php
	Version:        Paratext 1.0
 ...
 * @since SnowFlat 1.0
 * @version 1.4
 * @author Paratext <http://www.paratext.org>
 * @copyright (c) 2014, Paratext
 * @license http://www.gnu.org/copyleft/gpl.html
 */
class qa_html_theme extends qa_html_theme_base
{
	protected $theme = 'paratextflat';
