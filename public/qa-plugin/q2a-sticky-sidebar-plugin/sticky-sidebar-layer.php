    ...
    function footer()
    {
        ...
        if ((int)qa_opt('sticky_sidebar_status')) { // If plugin is enabled in admin panel
            ...
            $this->output(
                ...
                "<script type='text/javascript'>if ($(window).width() > 991) {var sidebar = new StickySidebar('" . $sidebar_selector . "', {containerSelector: '" . $parent_selector . "',innerWrapperSelector: '" . $inner_selector . "',topSpacing: " . $top_spacing . ",bottomSpacing: " . $bottom_spacing . "});}</script>"
            );
        }
