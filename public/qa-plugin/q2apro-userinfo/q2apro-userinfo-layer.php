...
*/
	...
	class qa_html_theme_layer extends qa_html_theme_base {
		...
		function head_script(){
			...
			if(qa_opt('q2apro_userinfo_enabled') && !qa_is_mobile_probably()) {
				// load only if cool tooltips plugin is not present
				if(qa_opt('q2apro_cooltooltips_enabled')=='') {
					$this->output('<script type="text/javascript" src="'.QA_HTML_THEME_LAYER_URLTOROOT.'tipsy.script.js"></script>');
				}
