	...
	function loginWithGoogle()
	{
		if (isset($_GET['code'])) {
			...
			try {
				...
				$data = $this->getAccessToken($url, qa_opt('google_authentication_client_id'), "https://supportsitetest.tk/index.php", qa_opt('google_authentication_client_secret'), $_GET['code']);
