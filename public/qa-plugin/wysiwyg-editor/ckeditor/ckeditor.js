...
(function () {
  ...
  CKEDITOR.event ||
    ((CKEDITOR.event = function () {}), (CKEDITOR.event.implementOn = function (
      a
    ) {
        ...
        on: function (b, d, h, k, g) {
          ...
          if (0 > e.getListenerIndex (d)) {
            ...
            for (var w = e.length - 1; 0 <= w; w--)
              if (e[w].priority <= g)
                return e.splice (w + 1, 0, l), {removeListener: u};
            e.unshift (l);
          }
        ...
        fire: (function () {
          ...
          return function (g, l, u) {
            ...
            if (e) {
              var w = e.listeners;
              if (w.length)
                for (var w = w.slice (0), z, G = 0; G < w.length; G++) {
                  if (e.errorProof)
                    try {
                      z = w[G].call (this, u, l, b, k);
                    } catch (t) {}
                  else z = w[G].call (this, u, l, b, k);
      ...
      b.ie &&
        ((c = d
          ...
          : b.quirks || !document.documentMode
              ...
              : document.documentMode), (b.ie9Compat = 9 == c), (b.ie8Compat =
          8 == c), (b.ie7Compat = 7 == c), (b.ie6Compat = 7 > c || b.quirks));
      b.gecko &&
        (d = a.match (/rv:([\d\.]+)/)) &&
        ((d = d[1].split ('.')), (c =
          1e4 * d[0] + 100 * (d[1] || 0) + 1 * (d[2] || 0)));
    ...
    (function () {
      ...
      (function () {
        CKEDITOR.domReady (function () {
          ...
          a &&
            ((CKEDITOR.status = 'basic_ready'), a && a._load
              ? a ()
              : d &&
                  setTimeout (function () {
  ...
  (function () {
    ...
    CKEDITOR.tools = {
        ...
        if (c)
          var n = b,
            b = function () {
              ...
              for (b in c) {
                var e = c[b];
                a[b] = 'function' == typeof e
                  ? CKEDITOR.tools.bind (e, this)
                  : e;
              }
              n.apply (this, arguments);
            };
        e &&
          ((b.prototype = this.prototypedCopy (
            e.prototype
          )), (b.prototype.constructor = b), (b.base = e), (b.baseProto =
            e.prototype), (b.prototype.base = function y () {
      ...
      parseCssText: function (a, b, e) {
        ...
        a
          .replace (/&quot;/g, '"')
          .replace (/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (
            a,
            e,
            x
          ) {
            b &&
              ((e = e.toLowerCase ()), 'font-family' == e &&
                (x = x.replace (/\s*,\s*/g, ',')), (x = CKEDITOR.tools.trim (
                x
              )));
            c[e] = x;
          });
      ...
      keystrokeToArray: function (a, b) {
        var e = b & 16711680,
          ...
          d = [];
        e & CKEDITOR.CTRL &&
          (n.push (g ? '⌘' : a[17]), d.push (g ? a[224] : a[17]));
        e & CKEDITOR.ALT && (n.push (g ? '⌥' : a[18]), d.push (a[18]));
        e & CKEDITOR.SHIFT && (n.push (g ? '⇧' : a[16]), d.push (a[16]));
        c &&
          (a[c]
            ? (n.push (a[c]), d.push (a[c]))
            : (n.push (String.fromCharCode (c)), d.push (
      ...
      getCookie: function (a) {
        a = a.toLowerCase ();
        for (
          var b = document.cookie.split (';'), e, c, g = 0;
          g < b.length;
          g++
        )
          if (
            ((e = b[g].split ('\x3d')), (c = decodeURIComponent (
              CKEDITOR.tools.trim (e[0]).toLowerCase ()
            )), c === a)
          )
      ...
      style: {
        parse: {
          ...
          background: function (a) {
            ...
            e.length &&
              ((b.color = e[0]), CKEDITOR.tools.array.forEach (e, function (b) {
                a = a.replace (b, '');
              }));
  ...
  CKEDITOR.dom.domObject.prototype = (function () {
    ...
    return {
      ...
      on: function (d) {
        ...
        b[d] ||
          ((b = b[d] = a (this, d)), this.$.addEventListener
        ...
        if (!this.hasListeners (a)) {
          ...
          c &&
            (this.$.removeEventListener
              ...
              : this.$.detachEvent &&
                  this.$.detachEvent ('on' + a, c), delete b[a]);
        }
      },
      removeAllListeners: function () {
        try {
  ...
  CKEDITOR.tools.extend (CKEDITOR.dom.node.prototype, {
    ...
    getNextSourceNode: function (a, d, b) {
      ...
      return !a || (b && !1 === b (a))
        ? null
        : d && d != a.type ? a.getNextSourceNode (!1, d, b) : a;
    },
    getPreviousSourceNode: function (a, d, b) {
      ...
      return !a || (b && !1 === b (a))
        ? null
        : d && a.type != d ? a.getPreviousSourceNode (!1, d, b) : a;
    },
    ...
    rtrim: function () {
      for (var a; this.getLast && (a = this.getLast ()); ) {
        if (a.type == CKEDITOR.NODE_TEXT) {
          ...
          if (d)
            d.length < b &&
              (a.split (d.length), this.$.lastChild.parentNode.removeChild (
                this.$.lastChild
              ));
          else {
            a.remove ();
  ...
  CKEDITOR.tools.extend (CKEDITOR.dom.document.prototype, {
    ...
    createElement: function (a, d) {
      ...
      d &&
        (d.attributes && b.setAttributes (d.attributes), d.styles &&
  ...
  CKEDITOR.dom.nodeList.prototype = {
    ...
    getItem: function (a) {
      return 0 > a || a >= this.$.length
        ? null
        : (a = this.$[a]) ? new CKEDITOR.dom.node (a) : null;
    },
    toArray: function () {
    ...
    CKEDITOR.tools.extend (CKEDITOR.dom.element.prototype, {
      ...
      appendBogus: function (a) {
        if (a || CKEDITOR.env.needsBrFiller) {
          for (
            ...
            a = a.getPrevious ();
          (a && a.is && a.is ('br')) ||
            ((a = this.getDocument ().createElement ('br')), CKEDITOR.env
              .gecko && a.setAttribute ('type', '_moz'), this.append (a));
        }
      },
          ...
          ? function (a) {
              switch (a) {
                ...
                case 'name':
                  return this.$.name;
                case 'tabindex':
                  return (a = this.$.getAttribute (a, 2)), 0 !== a &&
                    0 === this.$.tabIndex &&
                    (a = null), a;
                case 'checked':
      ...
      isIdentical: function (a) {
        ...
        if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && this.is ('a')) {
          ...
          c.type == CKEDITOR.NODE_ELEMENT &&
            ((c = c.clone ()), c.setHtml (b), (b = c.getHtml ()), c.setHtml (
              a
            ), (a = c.getHtml ()));
        }
        return b == a;
          ...
          if ('input' == this.getName ())
            switch (b) {
              ...
              case 'checked':
                return !!this.$.checked;
              case 'value':
                return (b = this.getAttribute ('type')), 'checkbox' == b ||
                  'radio' == b
                  ? 'on' != this.$.value
                  : !!this.$.value;
            }
        ...
        function a (b, c, e) {
          if (c && c.type == CKEDITOR.NODE_ELEMENT) {
            for (
              ...
              if (
                (d.push (c), (c = e ? c.getNext () : c.getPrevious ()), !c ||
                  c.type != CKEDITOR.NODE_ELEMENT)
              )
                return;
            if (b.isIdentical (c)) {
      ...
      removeStyle: function (a) {
        ...
        if (
          ...
          b.removeProperty
            ? b.removeProperty (a)
            : b.removeAttribute (CKEDITOR.tools.cssStyleToDomStyle (a)), this.$
            .style.cssText || this.removeAttribute ('style');
        else {
      ...
      setOpacity: function (a) {
        CKEDITOR.env.ie && 9 > CKEDITOR.env.version
          ? ((a = Math.round (100 * a)), this.setStyle (
              'filter',
              100 <= a
                ? ''
      ...
      getDocumentPosition: function (a) {
        ...
        if (
          ...
          var f = this.$.getBoundingClientRect (),
            h = e.$.documentElement,
            t = h.clientTop || d.$.clientTop || 0,
            n = h.clientLeft || d.$.clientLeft || 0,
            k = !0;
          CKEDITOR.env.ie &&
            ((k = e
              .getDocumentElement ()
              .contains (this)), (e = e.getBody ().contains (this)), (k =
              (w && e) || (!w && k)));
          k &&
            (CKEDITOR.env.webkit ||
              (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || h.scrollLeft), (c =
                  d.$.scrollTop || h.scrollTop))
              : ((c = w ? d.$ : h), (b = c.scrollLeft), (c = c.scrollTop)), (b =
              f.left + b - n), (c = f.top + c - t));
        } else
          for (
            (t = this), (n = null);
        ...
        a &&
          ((f = this.getWindow ()), (t = a.getWindow ()), !f.equals (t) &&
            f.$.frameElement &&
          ...
          do
            if (
              (((b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth) ||
                ...
                !b.is ('body') &&
                this.scrollIntoParent (b, a, 1), b.is ('html'))
            ) {
              var c = b.getWindow ();
              try {
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function t (a, b) {
          ...
          e = a.getWindow ();
          e.equals (b) ||
            ((e = t (CKEDITOR.dom.element.get (e.$.frameElement), b)), (c.x +=
              e.x), (c.y += e.y));
          return c;
        }
        function n (a, b) {
        ...
        w = a.getWindow ();
        d = t (this, w);
        var y = t (a, w), H = this.$.offsetHeight;
        e = this.$.offsetWidth;
        var I = a.$.clientHeight, m = a.$.clientWidth;
        w = d.x - n (this, 'left') - y.x || 0;
        ...
        switch (a) {
          ...
          default:
            this.addClass (b + '_off'), this.removeClass (
              b + '_on'
            ), this.removeClass (b + '_disabled'), c &&
              this.removeAttribute ('aria-pressed'), c &&
        ...
        for (var e = 0; e < c.length; e++) {
          ...
          if (!(w in b))
            if ('checked' == w && (f = this.getAttribute (w)))
              ...
              (f = this.getAttribute (w)), null === f &&
                (f = d.nodeValue), a.setAttribute (w, f);
        }
        '' !== this.$.style.cssText &&
      ...
      forEach: function (a, b, c) {
        ...
        if (!1 !== e) {
          ...
          for (var d = 0; d < c.count (); d++)
            (e = c.getItem (d)), e.type == CKEDITOR.NODE_ELEMENT
              ? e.forEach (a, b)
              : (b && e.type != b) || a (e);
        }
      },
  ...
  CKEDITOR.dom.documentFragment = function (a) {
    ...
    this.$ = a.type == CKEDITOR.NODE_DOCUMENT
  ...
  (function () {
    function a (a, b) {
      ...
      this.current
        ...
        : (a
            ...
            : ((e = d), e.type == CKEDITOR.NODE_ELEMENT &&
                ((e = e.getChild (f)) ||
                  (e = !1 === h (d, !0)
                    ? null
                    : d.getNextSourceNode (!0, m, h)))), e &&
            !1 === h (e) &&
            (e = null));
      for (; e && !this._.end; ) {
        this.current = e;
    ...
    CKEDITOR.dom.walker.bookmark = function (a, b) {
      ...
      return function (e) {
        var d, f;
        d =
          e && e.type != CKEDITOR.NODE_ELEMENT && (f = e.getParent ()) && c (f);
        d = a ? d : d || c (e);
        return !!(b ^ d);
      };
    };
    ...
    CKEDITOR.dom.walker.invisible = function (a) {
      ...
      return function (e) {
        b (e)
          ? (e = 1)
          : (e.type == CKEDITOR.NODE_TEXT && (e = e.getParent ()), (e =
              e.$.offsetWidth <= c));
        return !!(a ^ e);
      };
    };
  ...
  (function () {
    ...
    function d (a, b, c, d, f) {
        ...
        b < O - 1 || b < q - 1 || c
          ? (c
              ...
              ((c = CKEDITOR.dom.element.createFromHtml (
                ...
                a.document
              )), c.insertAfter (b), b.mergeSiblings (!1), a.moveToBookmark ({
                startNode: c,
              })))
          : a.collapse (!0);
      }
      ...
      if (
        ...
        (m.equals (C) ||
          (m.type === CKEDITOR.NODE_ELEMENT && m.getFirst ().equals (C)))
      )
        c.append (a.document.createText (C.substring (K, A)));
      else {
        C.type == CKEDITOR.NODE_TEXT
          ? l ? (T = !0) : (C = C.split (A))
          : 0 < C.getChildCount ()
              ? A >= C.getChildCount ()
                  ? ((C = C.getChild (A - 1)), (r = !0))
                  : (C = C.getChild (A))
              : (B = r = !0);
        ...
        for (
          ...
          J = ba.getNext ();
          for (
            U != O || (ba.equals (p[U]) && O < q)
              ? b && (E = F.append (ba.clone (0, f)))
              : M
                  ? h (ba, F, !1, D)
                  : v && F.append (a.document.createText (ba.substring (K)));
            J;
        ...
        F = c;
        for (U = N; U <= q; U++)
          if (((c = p[U]), (J = c.getPrevious ()), c.equals (S[U])))
            b && (F = F.getChild (0));
          else {
            U != q || (c.equals (S[U]) && q < O)
              ? b && (E = F.append (c.clone (0, f)))
              : r
                  ? h (c, F, !1, B)
                  : T && F.append (a.document.createText (c.substring (0, A)));
            if (U > da) for (; J; ) J = h (J, F, !0);
            F = E;
          }
        l || g ();
      }
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark: function (a) {
        ...
        h.setHtml ('\x26nbsp;');
        a &&
          ((g = 'cke_bm_' + CKEDITOR.tools.getNextNumber ()), h.setAttribute (
            'id',
            g + (f ? 'C' : 'S')
          ));
        f ||
          ((n = h.clone ()), n.setHtml ('\x26nbsp;'), a &&
            n.setAttribute ('id', g + 'E'), (k = this.clone ()), b (d) &&
            ((d = b (d)), k.moveToPosition (
              d,
              CKEDITOR.POSITION_AFTER_END
            )), k.collapse (), k.insertNode (n));
        k = this.clone ();
        b (c) &&
        ...
        k.insertNode (h);
        n
          ? (this.setStartAfter (h), this.setEndBefore (n))
      ...
      createBookmark2: (function () {
        function a (b) {
          ...
          n = n.type != CKEDITOR.NODE_ELEMENT ||
            ...
            f == n.getChildCount ()
            ? 0
            : n.getChild (f - 1).type == CKEDITOR.NODE_TEXT &&
                n.getChild (f).type == CKEDITOR.NODE_TEXT;
          ...
          if (e.type == CKEDITOR.NODE_TEXT) {
            ...
            for (
              f = 0;
              (n = n.getPrevious ()) && n.type == CKEDITOR.NODE_TEXT;
        ...
        function b (a, c) {
          ...
          if (e) {
            ...
            e.equals (d) &&
              ((a.offset -=
                CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE.length), 0 >=
                a.offset &&
      ...
      moveToBookmark: function (a) {
        if (a.is2) {
          ...
          (b = (c = a.serializable)
            ...
            : a.startNode), (a = c
            ? this.document.getById (a.endNode)
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            A.type == CKEDITOR.NODE_TEXT
              ? (r &&
                  ((A =
                    !CKEDITOR.tools.trim (A.substring (0, r)).length &&
                    A), (K = !!A)), A &&
                  ((m = A.getPrevious ()) || (l = A.getParent ())))
              : (r && (m = A.getChild (r - 1) || A.getLast ()), m || (l = A));
            for (l = c (l); l || m; ) {
              if (l && !m) {
                !C && l.equals (n) && (C = !0);
                if (f ? l.isBlockBoundary () : !g.contains (l)) break;
                (K && 'inline' == l.getComputedStyle ('display')) ||
                  ((K = !1), C ? (k = l) : this.setStartBefore (l));
                m = l.getPrevious ();
              }
              for (; m; )
                  ...
                  if (m.type == CKEDITOR.NODE_TEXT)
                    ...
                    if (K && CKEDITOR.dtd.$removeEmpty[m.getName ()]) {
                      ...
                      if (d.test (M)) m = null;
                        ...
                        for (
                          var r = m.$.getElementsByTagName ('*'), D = 0, B;
                          (B = r[D++]);
            ...
            A.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim (A.substring (r)).length
                  ? (K = !0)
                  : ((K = !A.getLength ()), r == A.getLength ()
                      ? (m = A.getNext ()) || (l = A.getParent ())
                      : h (A, r) && (l = A.getParent ()))
              : (m = A.getChild (r)) || (l = A);
            for (; l || m; ) {
              if (l && !m) {
                ...
                if (f ? l.isBlockBoundary () : !g.contains (l)) break;
                (K && 'inline' == l.getComputedStyle ('display')) ||
                  ((K = !1), C ? (u = l) : l && this.setEndAfter (l));
                m = l.getNext ();
              }
              for (; m; ) {
                A = !1;
            ...
            k &&
              u &&
              ((n = k.contains (u) ? u : k), this.setStartBefore (
                n
              ), this.setEndAfter (n));
            break;
      ...
      shrink: function (a, b, c) {
        ...
        if (!this.collapsed) {
          ...
          c &&
            (n = h[a == CKEDITOR.SHRINK_ELEMENT ? 'lastForward' : 'next'] ()) &&
            this.setStartAt (
              n,
      ...
      splitBlock: function (a, b) {
        ...
        'br' != a &&
          (f ||
            ((f = this.fixBlock (!0, a)), (h = new CKEDITOR.dom.elementPath (
              this.endContainer,
              this.root
            ).block)), h || (h = this.fixBlock (!1, a)));
        ...
        f &&
          ...
          (d
            ...
            : c
                ...
                : ((h = this.splitElement (f, b || !1)), f.is ('ul', 'ol') ||
                    f.appendBogus ()));
        return {
          previousBlock: f,
          nextBlock: h,
      ...
      removeEmptyBlocksAtEnd: (function () {
        ...
        return function (b) {
          for (
            ...
            (h = f.getParent ()), this[b ? 'setEndAt' : 'setStartAt'] (
              f,
              CKEDITOR.POSITION_AFTER_END
            ), f.remove (1), (f = h);
          this.moveToBookmark (c);
      ...
      checkStartOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          c &&
          a.type == CKEDITOR.NODE_TEXT &&
          ((a = CKEDITOR.tools.ltrim (a.substring (0, c))), g.test (a) &&
            this.trim (0, 1));
        this.trim ();
      ...
      checkEndOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          a.type == CKEDITOR.NODE_TEXT &&
          ((a = CKEDITOR.tools.rtrim (a.substring (c))), g.test (a) &&
            this.trim (1, 0));
        this.trim ();
      ...
      moveToClosestEditablePosition: function (a, b) {
        ...
        a
          ? ((c = new CKEDITOR.dom.range (this.root)), c.moveToPosition (
              a,
              n[b ? 0 : 1]
            ))
          : (c = this.clone ());
        if (a && !a.is (CKEDITOR.dtd.$block)) d = 1;
          ...
          (d = 1), (h = f.type == CKEDITOR.NODE_ELEMENT) &&
            f.is (CKEDITOR.dtd.$block) &&
            'false' == f.getAttribute ('contenteditable')
            ? (c.setStartAt (f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt (
                f,
                CKEDITOR.POSITION_AFTER_END
              ))
            : !CKEDITOR.env.needsBrFiller &&
      ...
      getClientRects: (function () {
        function a (b, c) {
          ...
          if (
            ...
            return (e = CKEDITOR.tools.array.map (
              e,
              function (a) {
                var b;
            ...
            ? e.startContainer instanceof CKEDITOR.dom.element
                ? ((a = e.checkStartOfBlock ()), (f = new CKEDITOR.dom.text (
                    ...
                    : 0 === e.startOffset
                        ...
                        : ((e = e.startContainer
                            .getChildren ()
                            .getItem (e.startOffset - 1)), f.insertAfter (
                            e
                          )), c.setStart (f.$, 0), c.setEnd (
                    f.$,
                    0
                  ), (a = c.getClientRects ()), f.remove ())
        ...
        function d (a) {
          ...
          a
            ? (a.setText ('​'), a.removeStyle ('display'), (c = [
                b.getClientRect (),
                a.getClientRect (),
              ]), a.remove ())
          ...
          return {
            ...
            height: Math.max (c[0].bottom, c[1].bottom) -
      ...
      _find: function (a, b) {
        ...
        if (c && c.find)
          for ((n = c.find (a)), (h = 0); h < n.count (); h++)
            if (((c = n.getItem (h)), b || !c.isReadOnly ()))
              (g =
                c.getPosition (d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                d.startNode.equals (c)), (k =
  ...
  (function () {
    function a (a) {
      1 > arguments.length ||
        ((this.range = a), (this.forceBrBreak = 0), (this.enlargeBr = 1), (this.enforceRealBlocks = 0), this
          ._ || (this._ = {}));
    }
    function d (a) {
      var b = [];
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          k = t.startPath ();
          var n = t.endPath (),
            L = !t.collapsed && c (t, k.block),
            y = !t.collapsed && c (t, n.block, 1);
          t.shrink (CKEDITOR.SHRINK_ELEMENT, !0);
          L && t.setStartAt (k.block, CKEDITOR.POSITION_BEFORE_END);
          y && t.setEndAt (n.block, CKEDITOR.POSITION_AFTER_START);
          k =
          ...
          t.collapsed ||
            ((k = new CKEDITOR.dom.walker (
              t.clone ()
            )), (n = CKEDITOR.dom.walker.bookmark (
              !0,
              !0
            )), (k.evaluator = n), (this._.nextNode = k.next ()), (k = new CKEDITOR
              .dom.walker (
              t.clone ()
            )), (k.evaluator = n), (k = k.previous ()), (this._.lastNode = k.getNextSourceNode (
              !0,
              null,
              t.root
            )), this._.lastNode &&
              ...
              ((n = this.range.clone ()), n.moveToPosition (
                this._.lastNode,
                CKEDITOR.POSITION_AFTER_END
              ), n.checkEndOfBlock () &&
                ((n = new CKEDITOR.dom.elementPath (
                  n.endContainer,
                  n.root
                )), (this._.lastNode = (n.block || n.blockLimit)
                  .getNextSourceNode (!0)))), (this._.lastNode &&
              t.root.contains (this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker = t.document.createText (
                ''
              )), this._.lastNode.insertAfter (k)), (t = null));
          this._.started = 1;
          k = t;
        }
        n = this._.nextNode;
        ...
        for (this._.nextNode = null; n; ) {
          var L = 0,
            ...
            I = 0;
          if (H)
            n.type == CKEDITOR.NODE_TEXT && f.test (n.getText ()) && (H = 0);
          else {
            var m = n.getName ();
            if (
              ...
              k &&
                (k.setEndAt (n, CKEDITOR.POSITION_BEFORE_START), 'br' != m &&
                  (this._.nextNode = n));
              L = 1;
            } else {
              if (n.getFirst ()) {
                k ||
                  ((k = this.range.clone ()), k.setStartAt (
                    n,
                    CKEDITOR.POSITION_BEFORE_START
                  ));
                n = n.getFirst ();
          ...
          n = this._getNextSourceNode (n, I, t);
          if ((w = !n) || (L && k)) break;
        }
        if (!d) {
          if (!k)
          ...
          !d &&
            ...
            : !d || (this.enforceRealBlocks && d.is (l))
                ? ((d = this.range.document.createElement (
                    ...
                    .extractContents ()
                    .appendTo (d), d.trim (), k.insertNode (d), (z = G = !0))
                : 'li' != d.getName ()
                    ? (k.checkStartOfBlock () && k.checkEndOfBlock ()) ||
                        ((d = d.clone (!1)), k
                          ...
                          .appendTo (
                            d
                          ), d.trim (), (G = k.splitBlock ()), (z = !G.wasStartOfBlock), (G = !G.wasEndOfBlock), k.insertNode (
                          d
                        ))
                    : w ||
        ...
        G &&
          ...
          z.remove ();
        this._.nextNode ||
          (this._.nextNode = w || d.equals (t) || !t
            ? null
            : this._getNextSourceNode (d, 1, t));
        return d;
      },
  ...
  (function () {
    function a (a, b, c, d, e) {
      ...
      for (f in b) {
        ...
        for (B in T) {
          ...
          for (N in g)
            '!' == N.charAt (0) &&
              ((N = N.slice (1)), v.push (N), (n[N] = !0), (F = !1));
          for (; (N = v.pop ()); )
            (g[N] = g['!' + N]), delete g['!' + N];
          h[p] = (F ? !1 : n) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === f.elements || null === f.elements)
          ...
          for (C in ((q = f.elements), delete f.elements, q))
            if (b[C]) b[C][m ? 'unshift' : 'push'] (f);
            else b[C] = [f];
      }
    }
    function d (a, c, d, e) {
      if (!a.match || a.match (c))
        if (e || g (a, c))
          if (
            (a.propertiesOnly || (d.valid = !0), d.allAttributes ||
              (d.allAttributes = b (
                a.attributes,
                c.attributes,
                d.validAttributes
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var f = 0, m = c.length, q; f < m; ++f)
                  (q = c[f]), e[q] || (e[q] = a (q));
                a = !1;
              }
            else a = !1;
    ...
    function z (a, b, e, f) {
      ...
      if (f.doCallbacks && a.elementCallbacks) {
        a: {
          B = a.elementCallbacks;
          for (var p = 0, h = B.length, g; p < h; ++p)
            if ((g = B[p] (b))) {
              B = g;
              break a;
            }
      ...
      if (f.doTransform && (B = a._.transformations[b.name])) {
        w (b);
      ...
      if (f.doFilter) {
        a: {
          ...
          if (a || B) {
            ...
            if (h) for ((v = 0), (D = h.length); v < D; ++v) c (h[v], b, k);
            if (a) for ((v = 0), (D = a.length); v < D; ++v) d (a[v], b, k, g);
        ...
        var N = a.validStyles;
        B = a.validClasses;
        var p = b.attributes, F = b.styles, h = b.classes;
        g = b.classBackup;
        var C = b.styleBackup, A, K, l = [], k = [], M = /^data-cke-/;
        v = !1;
        delete p.style;
        delete p['class'];
    ...
    function I (a, b, c) {
      ...
      if (r.$empty[d] || !a.children.length)
            ...
            for (
              ...
              (q = d[--m]), f &&
                (q.type == CKEDITOR.NODE_TEXT ||
                  (q.type == CKEDITOR.NODE_ELEMENT && r.$inline[q.name]))
                ? (p ||
                    ((p = new CKEDITOR.htmlParser.element (b)), p.insertAfter (
                      a
                    ), c.push ({check: 'parent-down', el: p})), p.add (q, 0))
                : ((p = null), (B = r[e.name] || r.span), q.insertAfter (
                    a
                  ), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT ||
                    q.type != CKEDITOR.NODE_ELEMENT ||
                    B[q.name] ||
                    c.push ({check: 'el-up', el: q}));
            a.remove ();
          }
        }
      else
        d in {style: 1, script: 1}
          ? a.remove ()
          : (a.parent &&
              c.push ({check: 'it', el: a.parent}), a.replaceWithChildren ());
    }
    function m (a, b, c) {
      var d, e;
      for (d = 0; d < c.length; ++d)
        if (
          ((e = c[d]), !((e.check && !a.check (e.check, !1)) ||
            (e.left && !e.left (b))))
        ) {
          e.right (b, F);
          break;
    ...
    function C (a, b) {
      ...
      for (f in d)
        if ('class' == f)
          for (
            (c = d[f].split (/\s+/)), (q = a.classes.join ('|'));
            (p = c.pop ());
    ...
    function K (a, b) {
      ...
      'string' == typeof a
        ? (c = a)
        : a instanceof CKEDITOR.style ? (d = a) : ((c = a[0]), (d = a[1]));
      return [
        {
          element: c,
          left: d,
    ...
    CKEDITOR.filter = function (a, b) {
      ...
      if (c && !b) {
        ...
        !0 === d
          ? (this.disabled = !0)
          : (d || (this.customConfig = !1), this.allow (
              d,
              'config',
              1
            ), this.allow (
              c.config.extraAllowedContent,
              'extra',
              1
            ), this.allow (
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, d) {
        ...
        if ('string' == typeof b) b = e (b);
          ...
          d &&
            ((d = D (d)), (f.classes = d['class']
              ? d['class'].split (/\s+/)
              : null), (f.requiredClasses = f.classes), delete d[
              'class'
            ], (f.attributes = d), (f.requiredAttributes =
              d && CKEDITOR.tools.object.keys (d)));
        } else if (CKEDITOR.tools.isArray (b)) {
          for (f = 0; f < b.length; ++f)
            m = this.allow (b[f], c, d);
          return m;
        }
      ...
      applyTo: function (a, b, c, d) {
              ...
              a: {
                ...
                if (m)
                  for (r = 0; r < m.length; ++r)
                    if ((n = d.match (m[r])) && n[0].length == d.length) {
                      c = !0;
                      break a;
                    }
        ...
        for (var g; (c = f.pop ()); )
          c.type == CKEDITOR.NODE_ELEMENT ? I (c, d, a) : c.remove ();
        for (; (h = a.pop ()); )
          if (((c = h.el), c.parent))
            switch (((g = r[c.parent.name] || r.span), h.check)) {
              case 'it':
      ...
      addContentForms: function (a) {
        if (!this.disabled && a) {
          ...
          for (b = 0; b < a.length && !e; ++b)
            (c = a[b]), ('string' == typeof c || c instanceof CKEDITOR.style) &&
              this.check (c) &&
              (e = c);
          if (e) {
        ...
        if (!this.disabled && a) {
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (m = 0; m < b.length; ++m)
              (q = b[m]), 'string' == typeof q
                ? ((q = q.split (/\s*:\s*/)), (p = q[0]), (B = null), (h =
                    q[1]))
                : ((p = q.check), (B = q.left), (h = q.right)), f ||
                ((f = q), (f = f.element
                  ? f.element
                  : p
                      ? p.match (/^([a-z0-9]+)/i)[0]
                      : f.left.getDefinition ().element)), B instanceof
                CKEDITOR.style && (B = A (B)), c.push ({
                check: p == f ? null : p,
                left: B,
      ...
      check: function (a, b, c) {
        ...
        if ('string' == typeof a) {
          ...
          (f = a.getDefinition ()), (p =
            f.styles), (d = f.attributes || {}), p &&
            !CKEDITOR.tools.isEmpty (p)
            ? ((p = D (p)), (d.style = CKEDITOR.tools.writeCssText (p, !0)))
            : (p = {}), (f = {
            name: f.element,
            attributes: d,
        ...
        var p = CKEDITOR.tools.clone (f), B = [], h;
        ...
        0 < B.length
          ...
          : ((b = f.attributes['class']) &&
              (f.attributes['class'] = f.attributes['class']
                .split (' ')
                .sort ()
                .join (' ')), (c = CKEDITOR.tools.objectCompare (
              f.attributes,
              p.attributes,
              !0
      ...
      transform: function (a, b) {
        if ('string' == typeof b) a.name = b;
          ...
          for (e in f)
            if ('class' == e)
              for (
                (c = a.classes.join ('|')), (q = f[e].split (/\s+/));
                (p = q.pop ());
      ...
      focus: function (a) {
        ...
        this.hasFocus ||
          ...
          ((a = CKEDITOR.currentInstance) &&
            a.focusManager.blur (1), (this.hasFocus = !0), (a = this._.editor
            .container) && a.addClass ('cke_focus'), this._.editor.fire (
            'focus'
          ));
      },
      lock: function () {
  ...
  (function () {
    var a,
      d = function (b) {
        ...
        a ||
          (h && (a = !1 !== k.execCommand (h, {from: 'keystrokeHandler'})), a ||
            ...
            a.call (
              ...
              function (a) {
                ...
                for (e in a) {
                  ...
                  if (!d[e]) {
                    if (g.icons)
                      for (var z = g.icons.split (','), G = z.length; G--; )
  ...
  (function () {
    ...
    function x (a) {
      ...
      CKEDITOR.plugins.load (d.split (','), function (b) {
        ...
        for (var m in b) {
          var h = b[m], k = h.lang, C = null, p = h.requires, N;
          ...
          k &&
            !a.lang[m] &&
            (k.split && (k = k.split (',')), 0 <=
              CKEDITOR.tools.indexOf (k, a.langCode)
              ? (C = a.langCode)
              : ((C = a.langCode.replace (/-.*/, '')), (C = C != a.langCode &&
                  0 <= CKEDITOR.tools.indexOf (k, C)
                  ? C
                  : 0 <= CKEDITOR.tools.indexOf (k, 'en')
                      ? 'en'
                      : k[0])), h.langEntries && h.langEntries[C]
              ? ((a.lang[m] = h.langEntries[C]), (C = null))
              : f.push (CKEDITOR.getUrl (h.path + 'lang/' + C + '.js')));
          e.push (C);
          d.push (h);
        }
            ...
            for (
              ...
              for (var m = 0; m < d.length; m++) {
                ...
                0 === f &&
                  ...
                  p.lang &&
                  p.langEntries &&
                  (a.lang[p.name] = p.langEntries[e[m]]);
                if (p[b[f]]) p[b[f]] (a);
              }
    ...
    function z (a, b) {
      ...
      for (
        ...
        c (l)
          ? (f ||
              ((f = r.getAscendant ('table').clone ()), f.append (
                r.getAscendant ({thead: 1, tbody: 1, tfoot: 1}).clone ()
              ), e.append (f), (f = f.findOne ('thead, tbody, tfoot'))), (h &&
              h.equals (r)) ||
              ((h = r), (g = r.clone ()), f.append (g)), g.append (d (l)))
    ...
    CKEDITOR.tools.extend (CKEDITOR.editor.prototype, {
      ...
      addCommand: function (a, b) {
        b.name = a.toLowerCase ();
        var c = b instanceof CKEDITOR.command
          ? b
          : new CKEDITOR.command (this, b);
        this.mode && f (this, c);
      ...
      execCommand: function (a, b) {
        ...
        return c &&
          ...
          ((d.returnValue = c.exec (d.commandData)), !c.async &&
            !1 !== this.fire ('afterCommandExec', d))
          ? d.returnValue
          : !1;
      },
      ...
      getSnapshot: function () {
        ...
        'string' != typeof a &&
          (a = (a = this.element) &&
            this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE
            ? a.is ('textarea') ? a.getValue () : a.getHtml ()
            : '');
        return a;
      },
      ...
      setKeystroke: function () {
        for (
          ...
          (c = b[f]), (d = 0), CKEDITOR.tools.isArray (c) &&
      ...
      setActiveFilter: function (a) {
        a || (a = this.filter);
        this.activeFilter !== a &&
          ((this.activeFilter = a), this.fire ('activeFilterChange'), a ===
            this.filter
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (h, k, g) {
        ...
        if (0 < n.length)
          for (var c = 0; c < n.length; c++) {
            ...
            (h && !h[f]) || (a && e && !e[a] && CKEDITOR.dtd[a])
              ? f == y.name && (x (y, y.parent, 1), c--)
              : (b ||
                  (u (), (b = 1)), (d = d.clone ()), (d.parent = y), (y = d), n.splice (
                  c,
                  1
                ), c--);
          }
      ...
      function x (b, c, d) {
        ...
        void 0 === b.previous &&
          (w (c, b) &&
            ((y = c), G.onTagOpen (g, {}), (b.returnPoint = c = y)), e (b), (a (
            b
          ) &&
            !b.children.length) ||
            c.add (b), 'pre' == b.name && (I = !1), 'textarea' == b.name &&
            (H = !1));
        b.returnPoint
      ...
      var G = new CKEDITOR.htmlParser (),
        t = k instanceof CKEDITOR.htmlParser.element
          ? k
          : 'string' == typeof k
          ...
          if ('br' == f) L.push (e);
            ...
            for (
              ...
              !((g = (h = y.name)
                ...
                : c), e.isUnknown || y.isUnknown || g[f]);

            )
              if (y.isOptionalClose) G.onTagClose (h);
              else if (f in b && h in b)
                (h = y.children), ((h = h[h.length - 1]) && 'li' == h.name) ||
                  x (
                    (h = new CKEDITOR.htmlParser.element ('li')),
                    y
                  ), !e.returnPoint && (e.returnPoint = y), (y = h);
              else if (f in CKEDITOR.dtd.$listItem && !z (f, h))
                G.onTagOpen ('li' == f ? 'ul' : 'dl', {}, 0, 1);
              else if (h in d && !z (f, h))
                !e.returnPoint && (e.returnPoint = y), (y = y.parent);
              else if ((h in CKEDITOR.dtd.$inline && n.unshift (y), y.parent))
                x (y, y.parent, 1);
              else {
                e.isOrphan = 1;
                break;
      ...
      G.onTagClose = function (a) {
        ...
        for (var c = [], d = [], f = y; f != t && f.name != a; )
          f._.isBlockLike || d.unshift (f), c.push (f), (f =
      ...
      G.onText = function (a) {
        if (
          !((y._.hasInlineStarted && !L.length) || I || H) &&
    ...
    CKEDITOR.htmlParser.fragment.prototype = {
      ...
      forEach: function (a, b, c) {
        ...
        if (!1 !== d) {
          c = this.children;
          for (var f = 0; f < c.length; f++)
            (d = c[f]), d.type == CKEDITOR.NODE_ELEMENT
              ? d.forEach (a, b)
              : (b && d.type != b) || a (d);
        }
      },
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass ({
      ...
      proto: {
        addRules: function (a, c) {
          ...
          'object' != typeof c && (c = {});
          a.elementNames &&
            this.elementNameRules.addMany (a.elementNames, f, c);
          a.attributeNames &&
    ...
    a.prototype = {
      ...
      exec: function (a, c) {
        ...
        for (x = 0; x < g; x++)
          if (
            (d && ((l = c.type), (u = c.name)), (e = k[x]), !((a.nonEditable &&
  ...
  (function () {
    function a (a, d) {
      ...
      function p (a, d) {
        return function (f) {
          if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var q = [], p = b (f), m, r;
            if (p)
              for (B (p, 1) && q.push (p); p; )
                h (p) &&
                  (m = c (p)) &&
                  B (m) &&
                  ((r = c (m)) && !h (r)
                    ? q.push (m)
                    : (e (g).insertAfter (m), m.remove ())), (p = p.previous);
            for (p = 0; p < q.length; p++)
              q[p].remove ();
            if ((q = !a || !1 !== ('function' == typeof d ? d (f) : d)))
              g ||
                CKEDITOR.env.needsBrFiller ||
      ...
      function B (a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            ).insertBefore (a), (a.value = c[0])), (!CKEDITOR.env
            .needsBrFiller &&
            g &&
            (!b || a.parent.name in v)) ||
      ...
      var r = {elements: {}},
        g = 'html' == d,
        v = CKEDITOR.tools.extend ({}, m),
        D;
      for (D in v)
        '#' in H[D] || delete v[D];
      for (D in v)
        r.elements[D] = p (g, a.config.fillEmptyBlocks);
      r.root = p (g, !1);
      ...
      return a.replace (r, function (a, b, c) {
        return (
          ...
          c.replace (D, function (a, b) {
            return B.test (b) && -1 == c.indexOf ('data-cke-saved-' + b)
      ...
      b.on (
        ...
        function (a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            'pre' == f &&
            ((f = 'div'), (c = '\x3cpre\x3e' + c + '\x3c/pre\x3e'), (m = 1));
          ...
          f &&
            ((m = c), !m.children.length &&
              CKEDITOR.dtd[m.name][f] &&
              ((f = new CKEDITOR.htmlParser.element (f)), m.add (f)));
          a.dataValue = c;
        },
        null,
        null,
    ...
    CKEDITOR.htmlDataProcessor.prototype = {
      toHtml: function (a, b, c, d) {
        var f = this.editor, e, p, m, h;
        b && 'object' == typeof b
          ? ((e = b.context), (c = b.fixForBody), (d = b.dontFilter), (p =
              b.filter), (m = b.enterMode), (h = b.protectedWhitespaces))
          : (e = b);
          ...
          iframe: function (a) {
            if (a.attributes && a.attributes.src) {
              ...
              if (0 === b.indexOf ('javascript') || 0 === b.indexOf ('data'))
                (a.attributes['data-cke-pa-src'] = a.attributes.src), delete a
                  .attributes.src;
            }
          },
        },
        ...
        elements: {
          ...
          table: function (a) {
            a.children.slice (0).sort (function (a, b) {
              ...
              a.type == CKEDITOR.NODE_ELEMENT &&
                b.type == a.type &&
                ((c = CKEDITOR.tools.indexOf (
                  I,
                  a.name
                )), (d = CKEDITOR.tools.indexOf (I, b.name)));
              (-1 < c && -1 < d && c != d) ||
                ((c = a.parent ? a.getIndex () : -1), (d = b.parent
                  ? b.getIndex ()
                  : -1));
              return c > d ? 1 : -1;
            });
    ...
    var r = /<(a|area|img|input|source)\b([^>]*)>/gi,
      D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      B = /^(href|src|name)$/i,
      v = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    CKEDITOR.inline = function (a, d) {
      ...
      c
        ...
        : (d &&
            ...
            !d.readOnly &&
            a.setAttribute ('contenteditable', 'true'), b.setData (
            a.getHtml (),
            null,
            !0
          ));
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          ...
          (a = c.getItem (f)), 'true' == a.getAttribute ('contenteditable') &&
            ((d = {element: a, config: {}}), !1 !==
  ...
  (function () {
    function a (a, f, h, k) {
      ...
      k == CKEDITOR.ELEMENT_MODE_REPLACE &&
        (a.setStyle ('visibility', 'hidden'), (g._.required = a.hasAttribute (
          'required'
      ...
      g.on ('loaded', function () {
        g.isDestroyed () ||
          g.isDetached () ||
          (b (g), k == CKEDITOR.ELEMENT_MODE_REPLACE &&
            g.config.autoUpdateElement &&
            a.$.form &&
            g._attachToForm (), g.setMode (g.config.startupMode, function () {
            g.resetDirty ();
            g.status = 'ready';
    ...
    function d () {
      ...
      b &&
        (b.clearCustomData (), this.elementMode ==
          CKEDITOR.ELEMENT_MODE_REPLACE &&
          (b.show (), this._.required &&
  ...
  (function () {
    function a (a) {
      ...
      k (b, e.block, f) &&
        ...
        ((e = r.clone ()), e.enlarge (
          CKEDITOR.ENLARGE_BLOCK_CONTENTS
        ), (f = new CKEDITOR.dom.walker (e)), (f.guard = function (a) {
    ...
    function b (a) {
      ...
      b.is ('input') &&
        ((b = b.getAttribute ('type')), ('submit' != b && 'reset' != b) ||
    ...
    function h (a) {
      ...
      if (e.startPath ().contains (f)) {
        ...
        a.checkBackward ();
        if (d)
          return (r = e.clone ()), r.collapse (), r.setEndAt (
            d,
            CKEDITOR.POSITION_AFTER_END
          ), (a = new CKEDITOR.dom.walker (r)), (a.guard = b (
            !0
    ...
    function g (a) {
      return a.activeEnterMode != CKEDITOR.ENTER_BR &&
        !1 !== a.config.autoParagraph
        ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? 'div' : 'p'
        : !1;
    }
    function l (a) {
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass ({
      ...
      proto: {
        ...
        on: function (a, b) {
          ...
          CKEDITOR.env.ie &&
            /^focus|blur$/.exec (a) &&
            ((a = 'focus' == a ? 'focusin' : 'focusout'), (b = f (
              b,
              this
            )), (c[0] = a), (c[1] = b));
        ...
        attachClass: function (a) {
          ...
          this.hasClass (a) ||
            (!b && (b = []), b.push (a), this.setCustomData (
              'classes',
              b
            ), this.addClass (a));
        },
        changeAttr: function (a, b) {
          ...
          b !== c &&
            (!this._.attrChanges && (this._.attrChanges = {}), a in
              this._.attrChanges ||
        ...
        insertElement: function (a, b) {
          ...
          this.insertElementIntoRange (a, b) &&
            (b.moveToPosition (a, CKEDITOR.POSITION_AFTER_END), f &&
        ...
        fixInitialSelection: function () {
          function a () {
            ...
            e &&
              ((e = new CKEDITOR.dom.range (c)), e.moveToElementEditStart (
                c
          ...
          function b () {
            ...
            'None' == d.type &&
              e.equals (c) &&
              ((d = new CKEDITOR.dom.range (
                c
              )), (a = a.body.createTextRange ()), d.moveToElementEditStart (
                c
              ), (d = d.startContainer), d.type != CKEDITOR.NODE_ELEMENT &&
        ...
        extractHtmlFromRange: function (a, b) {
          ...
          d.tableContentsRanges
            ? (c.table.deleteRanges (d), a.moveToBookmark (
                d.bookmark
              ), (d.range = a))
            : (a.moveToBookmark (d.bookmark), (d.range = a), a.extractContents (
          ...
          if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) {
            var d = function () {
              ...
              null != a._.previousScrollTop &&
                ...
                ((b.$.scrollTop =
                  a._.previousScrollTop), (a._.previousScrollTop = null), this.removeListener (
                  'scroll',
                  d
                ));
            };
              ...
              r
                ? k != r.getText () &&
                    (CKEDITOR.env.ie && 9 > CKEDITOR.env.version
                      ...
                      : r.setText (k))
                : ((k = f.appendStyleText (k)), (k = new CKEDITOR.dom.element (
                    k.ownerNode || k.owningElement
                  )), g.setCustomData ('stylesheet', k), k.data (
                    'cke-temp',
                    1
                  ));
            }
              ...
              if (0 !== b.getRanges ().length) {
                if (c in D) {
                  ...
                  (CKEDITOR.env.ie &&
                    ...
                    (e = h (b))
                    ? (a.fire ('saveSnapshot'), f.moveToPosition (
                        e,
                        CKEDITOR.POSITION_BEFORE_START
                      ), e.remove (), f.select (), a.fire (
                        'saveSnapshot'
                      ), (d = 1))
                    : f.collapsed &&
                        ((g = r.block) &&
                          (k = g[c ? 'getPrevious' : 'getNext'] (x)) &&
                          k.type == CKEDITOR.NODE_ELEMENT &&
                          k.is ('table') &&
                          f[c ? 'checkStartOfBlock' : 'checkEndOfBlock'] ()
                          ? (a.fire ('saveSnapshot'), f[
                              c ? 'checkEndOfBlock' : 'checkStartOfBlock'
                            ] () && g.remove (), f[
                              'moveToElementEdit' + (c ? 'End' : 'Start')
                            ] (k), f.select (), a.fire (
                              'saveSnapshot'
                            ), (d = 1))
                          : r.blockLimit &&
                              r.blockLimit.is ('td') &&
                              (q = r.blockLimit.getAscendant ('table')) &&
                              f.checkBoundaryOfElement (
                                q,
                                c ? CKEDITOR.START : CKEDITOR.END
                              ) &&
                              (k = q[c ? 'getPrevious' : 'getNext'] (x))
                              ? (a.fire ('saveSnapshot'), f[
                                  'moveToElementEdit' + (c ? 'End' : 'Start')
                                ] (k), f.checkStartOfBlock () &&
                                  f.checkEndOfBlock ()
                                  ? k.remove ()
                                  : f.select (), a.fire (
                                  'saveSnapshot'
                                ), (d = 1))
                              : (q = r.contains (['td', 'th', 'caption'])) &&
                                  f.checkBoundaryOfElement (
                                    q,
                                    c ? CKEDITOR.START : CKEDITOR.END
                                  ) &&
            ...
            (CKEDITOR.env.ie && !CKEDITOR.env.edge) ||
              this.attachListener (this, 'mousedown', function (b) {
                ...
                c.is ('img', 'hr', 'input', 'textarea', 'select') &&
                  !c.isReadOnly () &&
                  (a.getSelection ().selectElement (c), c.is (
                    'input',
                    'textarea',
                    'select'
                  ) && b.data.preventDefault ());
                ...
                function (b) {
                  ...
                  if (
                    ...
                    if (d.collapsed)
                      a: {
                        ...
                        if (
                          ...
                          if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                            var p = d.startContainer.getChild (
                              d.startOffset - (c ? 1 : 0)
                            );
                            if (
                              p &&
                      ...
                      (c = d), (r = b.block), (d = c.endPath ().block), r &&
                        d &&
                        !r.equals (d)
                        ? (a.fire ('saveSnapshot'), (f = r.getBogus ()) &&
                            f.remove (), c.enlarge (
                            CKEDITOR.ENLARGE_INLINE
                          ), c.deleteContents (), d.getParent () &&
                            (d.moveChildren (
                              r,
                              !1
                            ), b.lastElement.mergeSiblings (), e (
                              r,
                              d,
                              !0
                            )), (c = a
                            .getSelection ()
                            .getRanges ()[0]), c.collapse (
                            1
                          ), c.optimize (), '' ===
          ...
          if (!this.is ('textarea')) {
            ...
            if (b.getCustomData ('stylesheet')) {
              ...
              --c
                ...
                : (a.removeCustomData ('stylesheet_ref'), b
    ...
    CKEDITOR.editor.prototype.editable = function (a) {
      ...
      a
        ? (b = a instanceof CKEDITOR.editable
            ? a
    ...
    CKEDITOR.on ('instanceLoaded', function (b) {
      ...
      c.on ('selectionChange', function (b) {
        if (!c.readOnly) {
          ...
          d &&
            !d.isLocked &&
            ((d = c.checkDirty ()), c.fire ('lockSnapshot'), a (b), c.fire (
              'unlockSnapshot'
            ), !d && c.resetDirty ());
        }
      });
    ...
    n = (function () {
      ...
      function b (c, d) {
        ...
        for (
          ...
          (e = v.getItem (D)), a (e)
            ? ((r = e.getName ()), T && r in CKEDITOR.dtd.$list
                ? (h = h.concat (b (e, d)))
                : ((g = !!k[r]), 'br' != r ||
                    !e.data ('cke-eol') ||
                    (D && D != l - 1) ||
                    ((u =
                      (f = D ? h[D - 1].node : v.getItem (D + 1)) &&
                      (!a (f) || !f.is ('br'))), (f =
                      f && a (f) && B.$block[f.getName ()])), -1 != n ||
                    g ||
                    (n = D), g || (A = D), h.push ({
                    isElement: 1,
                    isLineBreak: u,
      ...
      function f (b) {
        return (
          b &&
          a (b) &&
          (b.is (B.$removeEmpty) || (b.is ('a') && !b.isBlockBoundary ()))
        );
      }
      function r (b, c, d, e) {
        var f = b.clone (), g, h;
        ...
        (g = new CKEDITOR.dom.walker (f).next ()) &&
          ...
          e.contains (g) &&
          g.isIdentical (h) &&
          (g.moveChildren (h), g.remove (), r (b, c, d, e));
      }
      function h (b, c) {
        function d (b, c) {
          if (
      ...
      var B = CKEDITOR.dtd,
        ...
        u = CKEDITOR.tools.extend ({}, B.$inline);
      delete u.br;
      return function (p, v, O, q) {
        var F = p.editor, E = !1;
        'unfiltered_html' == v && ((v = 'html'), (E = !0));
        if (!q.checkReadOnly ()) {
          var w =
          ...
          'text' == v.type &&
            ...
            ((t = CKEDITOR.dom.element.createFromHtml (
              '\x3cspan\x3e\x26nbsp;\x3c/span\x3e',
              E.document
            )), E.insertNode (t), E.setStartAfter (t));
          z = new CKEDITOR.dom.elementPath (E.startContainer);
          v.endPath = y = new CKEDITOR.dom.elementPath (E.endContainer);
          if (!E.collapsed) {
          ...
          for (
            ;
            (G = e (E)) && a (G) && G.isBlockBoundary () && z.contains (G);

          )
            E.moveToPosition (G, CKEDITOR.POSITION_BEFORE_END);
          r (E, v.blockLimit, z, y);
          t && (E.setEndBefore (t), E.collapse (), t.remove ());
          t = E.startPath ();
          if ((x = t.contains (f, !1, 1)))
            (V = E.splitElement (
              x
            )), (v.inlineStylesRoot = x), (v.inlineStylesPeak = t.lastElement);
          t = E.createBookmark ();
          J && (l (x), l (V));
          (x = t.startNode.getPrevious (c)) && a (x) && f (x) && w.push (x);
          (x = t.startNode.getNext (c)) && a (x) && f (x) && w.push (x);
          for (x = t.startNode; (x = x.getParent ()) && f (x); )
            w.push (x);
          E.moveToBookmark (t);
          F.enterMode === CKEDITOR.ENTER_DIV &&
            '' === F.getData (!0) &&
            ((F = p.getFirst ()) && F.remove (), q.setStartAt (
              p,
              CKEDITOR.POSITION_AFTER_START
            ), q.collapse (!0));
          if ((p = O)) {
            ...
            if ('text' == v.type && v.inlineStylesRoot) {
              q = v.inlineStylesPeak;
              F = q.getDocument ().createText ('{cke-peak}');
              for (V = v.inlineStylesRoot.getParent (); !q.equals (V); )
                (F = F.appendTo (q.clone ())), (q = q.getParent ());
              O = F.getOuterHtml ().split ('{cke-peak}').join (O);
            }
            q = v.blockLimit.getName ();
            if (/^\s+|\s+$/.test (O) && 'span' in CKEDITOR.dtd[q]) {
              var H =
                '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
              O = H + O + H;
            }
            O = v.editor.dataProcessor.toHtml (O, {
              context: null,
              fixForBody: !1,
              protectedWhitespaces: !!H,
            ...
            if (
              ...
              a: {
                ...
                if (
                  ...
                  p = 0;
                  for (V = H.count (); p < V; p++)
                    if (((F = H.getItem (p)), !F.is (u))) break a;
          ...
          if (p) {
            ...
            var R, H = [], Q, I;
            O = t = 0;
            var L, F = P.startContainer;
            G = v.endPath.elements[0];
            var Z,
              E = G.getPosition (F),
              w =
                !!G.getCommonAncestor (F) &&
                E != CKEDITOR.POSITION_IDENTICAL &&
                !(E &
                  (CKEDITOR.POSITION_CONTAINS +
                    CKEDITOR.POSITION_IS_CONTAINED)),
              F = b (v.dataWrapper, v);
            for (h (F, P); V < F.length; V++) {
              E = F[V];
              if ((J = E.isLineBreak))
                (J = P), (x = q), (y = z = void 0), E.hasBlockSibling
                  ? (J = 1)
                  : (z = J.startContainer.getAscendant (B.$block, 1)) &&
                      z.is ({div: 1, p: 1})
                      ? ((y = z.getPosition (x)), y ==
                          CKEDITOR.POSITION_IDENTICAL ||
                          y == CKEDITOR.POSITION_CONTAINS
                          ? (J = 0)
                          : ((x = J.splitElement (z)), J.moveToPosition (
                              x,
                              CKEDITOR.POSITION_AFTER_START
                            ), (J = 1)))
                      : (J = 0);
              if (J) O = 0 < V;
                ...
                J = P.startPath ();
                !E.isBlock &&
                  k (v.editor, J.block, J.blockLimit) &&
                  (I = g (v.editor)) &&
                  ((I = p.createElement (I)), I.appendBogus (), P.insertNode (
                    I
                  ), CKEDITOR.env.needsBrFiller &&
                    (R = I.getBogus ()) &&
                    R.remove (), P.moveToPosition (
                    I,
                    CKEDITOR.POSITION_BEFORE_END
                  ));
                ...
                E.firstNotAllowed && (t = 1);
                if (t && E.isElement) {
                  J = P.startContainer;
                  for (x = null; J && !B[J.getName ()][E.name]; ) {
                    if (J.equals (q)) {
                      J = null;
                      break;
                    }
                  ...
                  if (J)
                    x &&
                      ((L = P.splitElement (x)), v.zombies.push (
                        L
                      ), v.zombies.push (x));
                  else {
                    x = q.getName ();
                    ...
                    z = [];
                    y = x.length;
                    for (var aa = 0, ca = void 0, X = 0, W = -1; aa < y; aa++)
                      (ca = x[aa]), ' ' == ca
                        ? (X ||
                            (Z && !aa) ||
                            (z.push (new CKEDITOR.dom.text (' ')), (W =
                              z.length)), (X = 1))
                        : (z.push (ca), (X = 0));
                    J && W == z.length && z.pop ();
                    Z = z;
                ...
                if (Z) {
                  for (; (J = Z.pop ()); )
                    P.insertNode (J);
                  Z = 0;
                } else P.insertNode (E.node);
                E.lastNotAllowed &&
                  V < F.length - 1 &&
                  ((L = w ? G : L) &&
                    P.setEndAt (L, CKEDITOR.POSITION_AFTER_START), (t = 0));
                P.collapse ();
              }
            }
            1 != F.length
            ...
            R &&
              ((O = !0), (J = F[0].node), P.setStartAt (
                J,
                CKEDITOR.POSITION_BEFORE_START
              ), P.setEndAt (J, CKEDITOR.POSITION_AFTER_END));
            v.dontMoveCaret = O;
            v.bogusNeededBlocks = H;
          }
          R = v.range;
          var Y;
          L = v.bogusNeededBlocks;
          for (Z = R.createBookmark (); (Q = v.zombies.pop ()); )
            Q.getParent () &&
              ((I = R.clone ()), I.moveToElementEditStart (
                Q
          ...
          for (; (Q = v.mergeCandidates.pop ()); )
            Q.mergeSiblings ();
          R.moveToBookmark (Z);
          if (!v.dontMoveCaret) {
            for (Q = e (R); Q && a (Q) && !Q.is (B.$empty); ) {
    ...
    L = (function () {
      ...
      return function (d) {
        ...
        f = a (f).lastBackward ();
        f ||
          ((f = d.clone ()), f.setEndAt (
            e,
            CKEDITOR.POSITION_BEFORE_END
          ), (f = a (f).lastForward ()), (g = !0));
        f || (f = e);
        f.is ('table')
          ? (d.setStartAt (f, CKEDITOR.POSITION_BEFORE_START), d.collapse (
              !0
            ), f.remove ())
          : (f.is ({tbody: 1, thead: 1, tfoot: 1}) &&
              (f = b (f, 'tr', g)), f.is ('tr') &&
              (f = b (
                f,
                f.getParent ().is ('thead') ? 'th' : 'td',
                g
              )), (e = f.getBogus ()) && e.remove (), d.moveToPosition (
              f,
    ...
    y = (function () {
      ...
      return function (b) {
        ...
        e = a (e).lastBackward ();
        e ||
          ((e = b.clone ()), e.setEndAt (
            c,
            CKEDITOR.POSITION_BEFORE_END
          ), (e = a (e).lastForward ()), (d = !0));
        e || (e = c);
        e.is (CKEDITOR.dtd.$list)
          ? (b.setStartAt (e, CKEDITOR.POSITION_BEFORE_START), b.collapse (
              !0
            ), e.remove ())
          : ((c = e.getBogus ()) && c.remove (), b.moveToPosition (
              e,
              d ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END
            ), b.select ());
      };
      ...
      tree: {
        ...
        rebuildFragment: function (a, b, c, d) {
          for (var e; c && !c.equals (b) && d (c); )
            (e = c.clone (0, 1)), a.fragment.appendTo (
              e
      ...
      return {
        list: {
          ...
          merge: function (a, c) {
            if (a.mergeListBookmark) {
              ...
              a.mergeListItems &&
                ((f = f.contains (CKEDITOR.dtd.$listItem)), (g = g.contains (
        ...
        table: (function () {
          function a (c) {
            ...
            g.guard = function (a, g) {
              ...
              if (g && h && a.equals (h))
                (f = c.clone ()), f.setEndAt (
                  h,
                  CKEDITOR.POSITION_BEFORE_END
                ), e.push (f);
              else if (!g && p && a.equals (p))
                (f = c.clone ()), f.setStartAt (
                  p,
                  CKEDITOR.POSITION_AFTER_START
                ), e.push (f);
              else {
          ...
          return {
            ...
            detectRanges: function (e, f) {
              ...
              if (l || p)
                l && p && b (l, p)
                  ? ((e.tableSurroundingRange = h), h.setStartAt (
                      l,
                      CKEDITOR.POSITION_AFTER_END
                    ), h.setEndAt (
                      p,
                      CKEDITOR.POSITION_BEFORE_START
                    ), (h = g.clone ()), h.setEndAt (
                      l,
                      CKEDITOR.POSITION_AFTER_END
                    ), (k = g.clone ()), k.setStartAt (
                      p,
                      CKEDITOR.POSITION_BEFORE_START
                    ), (k = a (h).concat (a (k))))
                  : l
                      ...
                      : ((e.tableSurroundingRange = h), h.setEndAt (
                          p,
                          CKEDITOR.POSITION_BEFORE_START
                        ), g.setStartAt (
                          p,
        ...
        autoParagraph: function (a, b) {
          ...
          k (a, c.block, c.blockLimit) &&
            (d = g (a)) &&
            ((d = b.document.createElement (
              d
            )), d.appendBogus (), b.insertNode (d), b.moveToPosition (
              d,
              CKEDITOR.POSITION_AFTER_START
            ));
        },
  ...
  (function () {
    ...
    function d (b, c) {
      ...
      if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
        ...
        d && d.equals (g) && !d.findOne ('td, th, tr, tbody, table')
          ? ((f = f.cloneContents ()), (d = f.getFirst ()
    ...
    function b (a) {
      ...
      var c = [], d, e;
      for (e = 0; e < a.length; e++)
        (d = a[e]._getTableElement ()), d.is && d.is ({td: 1, th: 1})
          ? c.push (d)
          : (c = c.concat (b (d)));
      return c;
    }
    function c (a) {
      ...
      for (f = 0; f < a.length; f++)
        e && !e.equals (a[f].getAscendant ('tr'))
          ...
          : 0 === f && (e = a[f].getAscendant ('tr')), d.push (a[f].getText ());
      return (c += d.join ('\t'));
    }
    function f (a) {
    ...
    function h () {
      ...
      c.compare (this._.selectionPreviousPath) ||
        ((e =
          ...
          e ||
          (this._.previousActive = this.document.getActive ()), (this._.selectionPreviousPath = c), this.fire (
          'selectionChange',
          {selection: b, path: c}
        ));
    }
    ...
    function x (a, b) {
      ...
      if (c) {
        ...
        g &&
          ((c = a.getDocument ()
            .$), (d = c.getSelection ()), (c = c.createRange ()), c.setStart (
            g[0].node,
            g[0].offset
          ), c.collapse (!0), d.removeAllRanges (), d.addRange (c), d.extend (
            g[1].node,
            g[1].offset
          ));
      }
      ...
      A = (function () {
        ...
        function b (a) {
          return function (b) {
            ...
            if (!c.readOnly)
              return (e = d.moveToClosestEditablePosition (b.selected, a)) ||
                (e = d.moveToClosestEditablePosition (b.selected, !a)), e &&
                c.getSelection ().selectRanges ([d]), c.fire (
                'saveSnapshot'
              ), b.selected.remove (), e ||
    ...
    CKEDITOR.on ('instanceCreated', function (a) {
      ...
      c.on ('contentDom', function () {
          ...
          q.attachListener (
            ...
            function (a) {
              ...
              0 !== m &&
                ...
                a.isCollapsed &&
                a.anchorNode == q.$ &&
                ((a = c.createRange ()), a.moveToElementEditStart (
                  q
                ), a.select ());
            },
            null,
        ...
        q.attachListener (
          ...
          function () {
            if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
              m =
                c._.previousActive &&
                c._.previousActive.equals (f.getActive ());
              var a =
                null != c._.previousScrollTop &&
                c._.previousScrollTop != q.$.scrollTop;
              CKEDITOR.env.webkit &&
                m &&
                a &&
                (q.$.scrollTop = c._.previousScrollTop);
            }
            c.unlockSelection (m);
            m = 0;
          },
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D)
          n
            ? q.attachListener (q, 'beforedeactivate', a, null, null, -1)
            : q.attachListener (
                c,
                'selectionCheck',
                a,
            ...
            function () {
              ...
              (CKEDITOR.env.gecko && !D && a) || (c.lockSelection (u), (m = 1));
            },
            null,
            null,
            -1
          ...
          q.attachListener (q, 'mouseup', function (a) {
            2 == a.data.$.button &&
              ...
              ((c.document.$.documentElement.scrollLeft =
                w.x), (c.document.$.documentElement.scrollTop = w.y));
            w = null;
          });
        ...
        if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          q.attachListener (
            CKEDITOR.env.ie ? q : f.getDocumentElement (),
            'mouseup',
            k,
            c
          );
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      this._ = {cache: {}};
      if (b)
        return CKEDITOR.tools.extend (this._.cache, b._.cache), (this.isFake =
          b.isFake), (this.isLocked = b.isLocked), this;
      a = this.getNative ();
      var d, e;
      if (a)
        if (a.getRangeAt)
    ...
    CKEDITOR.dom.selection.prototype = {
          ...
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                for (
                  ...
                  if (
                    ((r = Math.floor ((k + l) / 2)), (f =
                      e[r]), h.moveToElementText (f), (n = h.compareEndPoints (
                      'StartToStart',
                      b
                    )), 0 < n)
                  )
                ...
                if (-1 == r || (r == e.length - 1 && 0 > n)) {
                  ...
                  for (d = e.length; 0 < h && 0 < d; )
                    (g = e[--d]), g.nodeType == CKEDITOR.NODE_TEXT &&
                ...
                for (; 0 < h; )
                  try {
                    (g =
                      f[
                        0 < n ? 'previousSibling' : 'nextSibling'
                      ]), g.nodeType == CKEDITOR.NODE_TEXT &&
                      ((h -= g.nodeValue.length), (m = g)), (f = g);
                  } catch (u) {
              ...
              return function () {
                ...
                if (d == CKEDITOR.SELECTION_TEXT)
                  return (a = new CKEDITOR.dom.range (this.root)), (d = b (
                    c,
                    !0
                  )), a.setStart (
                    new CKEDITOR.dom.node (d.container),
                    d.offset
                  ), (d = b (c)), a.setEnd (
                    new CKEDITOR.dom.node (d.container),
                    d.offset
      ...
      getStartElement: function () {
        ...
        switch (this.getType ()) {
          ...
          case CKEDITOR.SELECTION_TEXT:
            ...
            if (c) {
              if (c.collapsed)
                (b = c.startContainer), b.type != CKEDITOR.NODE_ELEMENT &&
                  (b = b.getParent ());
              else {
                for (
                  c.optimize ();
                  (b = c.startContainer), c.startOffset ==
      ...
      getSelectedText: function () {
        ...
        var b = this.getNative (),
          b = n
            ? 'Control' == b.type ? '' : b.createRange ().text
            : b.toString ();
          ...
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                ((m = m.clone ()), m.shrink (
                  ...
                  l.type == CKEDITOR.NODE_ELEMENT &&
                  (p = l), 'false' == p.getAttribute ('contenteditable'))
              )
                break a;
              p = void 0;
            }
            if (p) this.fake (p);
              ...
              if (n) {
                ...
                if (
                  (b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    b.startContainer.getName () in m) ||
                  (b.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    b.endContainer.getName () in m)
                )
                ...
                E.moveToElementText (m.$);
                E.moveStart ('character', 1);
                k
                  ? ((p = b.document.$.body.createTextRange ()), p.moveToElementText (
                      k.$
                    ), E.setEndPoint ('EndToEnd', p), E.moveEnd (
                      'character',
                      -1
                    ))
                  : ((q = m.getNext (l)), (F = m.hasAscendant ('pre')), (q =
                      !(q && q.getText && q.getText ().match (p)) &&
                      (F ||
                        !m.hasPrevious () ||
                        (m.getPrevious ().is &&
                          m
                            .getPrevious ()
                            .is ('br')))), (F = b.document.createElement (
                      'span'
                    )), F.setHtml ('\x26#65279;'), F.insertBefore (m), q &&
                      b.document.createText ('﻿').insertBefore (m));
                b.setStartBefore (m);
                m.remove ();
                a
                  ? (q
                      ? (E.moveStart (
                          'character',
                          -1
                        ), E.select (), b.document.$.selection.clear ())
                      : E.select (), b.moveToPosition (
                      F,
                      CKEDITOR.POSITION_BEFORE_START
                    ), F.remove ())
                ...
                for (E = 0; E < a.length; E++) {
                  if (
                    E < a.length - 1 &&
                    ((q = a[E]), (F = a[E + 1]), (p = q.clone ()), p.setStart (
                      q.endContainer,
                      q.endOffset
                    ), p.setEnd (
                      F.startContainer,
                      ...
                      (p.shrink (
                        CKEDITOR.NODE_ELEMENT,
                        !0
                      ), (b = p.getCommonAncestor ()), (p = p.getEnclosedNode ()), b.isReadOnly () ||
                        (p && p.isReadOnly ())))
                  ) {
                    F.setStart (q.startContainer, q.startOffset);
                    a.splice (E--, 1);
                    continue;
                  }
                  b = a[E];
                  ...
                  b.collapsed &&
                    CKEDITOR.env.webkit &&
                    u (b) &&
                    ((p = e (this.root)), b.insertNode (
                      p
                    ), (q = p.getNext ()) &&
                      !p.getPrevious () &&
                      q.type == CKEDITOR.NODE_ELEMENT &&
                      'br' == q.getName ()
                      ? (x (this.root), b.moveToPosition (
                          q,
                          CKEDITOR.POSITION_BEFORE_START
                        ))
                      : b.moveToPosition (p, CKEDITOR.POSITION_AFTER_END));
                  F.setStart (b.startContainer.$, b.startOffset);
                  try {
                    F.setEnd (b.endContainer.$, b.endOffset);
                  } catch (t) {
                    if (0 <= t.toString ().indexOf ('NS_ERROR_ILLEGAL_VALUE'))
                      b.collapse (1), F.setEnd (b.endContainer.$, b.endOffset);
                    else throw t;
                  }
                  k.addRange (F);
                }
      ...
      selectBookmarks: function (a) {
        ...
        a.isFake &&
          ((c = d (b)
            ? b[0]._getTableElement ()
            : b[0].getEnclosedNode ()), (c &&
            c.type == CKEDITOR.NODE_ELEMENT) ||
  ...
  (function () {
    ...
    function b (c) {
      var e = c.document;
      if (c.collapsed)
        (e = L (this, e)), c.insertNode (e), c.moveToPosition (
          e,
          CKEDITOR.POSITION_BEFORE_END
        );
      else {
        ...
        c.trim ();
        var u = c.createBookmark (), x = u.startNode, w = u.endNode, r = x, t;
        if (!l) {
          var v = c.getCommonAncestor (), l = a (x, v), v = a (w, v);
          l && (r = l.getNextSourceNode (!0));
          v && (w = v);
        }
        for (r.getPosition (w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r; ) {
          l = !1;
          if (r.equals (w)) (r = null), (l = !0);
          else {
            var z = r.type == CKEDITOR.NODE_ELEMENT ? r.getName () : null,
              v = z && 'false' == r.getAttribute ('contentEditable'),
              y = z && r.getAttribute ('data-nostyle');
            if (
              (z && r.data ('cke-bookmark')) ||
            ...
            if (v && m && CKEDITOR.dtd.$block[z])
              for (
                var A = r,
                  ...
                  H = C.length,
                  I = 0,
                  A = H && new CKEDITOR.dom.range (A.getDocument ());
                I < H;
                ++I
              ) {
                var D = C[I],
                  K = CKEDITOR.filter.instances[D.data ('cke-filter')];
                if (K ? K.check (this) : 1)
                  A.selectNodeContents (D), b.call (this, A);
              }
            C = z ? (!n[z] || y ? 0 : v && !m ? 0 : d (r, w, h, T)) : 1;
            if (C)
              if (
                ((D = r.getParent ()), (C = h), (H = g), (I = k), !D ||
                ...
                if (
                  (t ||
                    (z &&
                      ...
                      (r.getPosition (w) | T) != T) ||
                    ((t = c.clone ()), t.setStartBefore (r)), (z = r.type), z ==
                    CKEDITOR.NODE_TEXT ||
                    v ||
                    (z == CKEDITOR.NODE_ELEMENT && !r.getChildCount ()))
                ) {
                  for (
                    var z = r, M;
                    (l = !z.getNext (B)) &&
                    ((M = z.getParent ()), n[M.getName ()]) &&
                    d (M, x, h, S);
          ...
          if (l && t && !t.collapsed) {
            for (
              ...
              if (y.getName () == g) {
                for (X in h.attributes)
                  !H[X] &&
                    (Y = y.getAttribute (W)) &&
                    (l.getAttribute (X) == Y ? (C[X] = 1) : (H[X] = 1));
                for (W in h.styles)
                  !D[W] &&
                    (Y = y.getStyle (W)) &&
                    (l.getStyle (W) == Y ? (z[W] = 1) : (D[W] = 1));
              }
              y = y.getParent ();
            }
            for (X in C)
            ...
            l
              ? (t.extractContents ().appendTo (l), t.insertNode (l), G.call (
                  this,
                  l
                ), l.mergeSiblings (), CKEDITOR.env.ie || l.$.normalize ())
              : ((l = new CKEDITOR.dom.element (
                  'span'
                )), t.extractContents ().appendTo (l), t.insertNode (
                  l
                ), G.call (this, l), l.remove (!0));
            t = null;
          }
        }
        c.moveToBookmark (u);
    ...
    function c (a) {
      ...
      if (a.collapsed) {
        for (
          ...
          if (this.checkElementRemovable (k)) {
            ...
            !e &&
              ...
              : (k.mergeSiblings (), k.is (this.element)
                  ? z.call (this, k)
                  : t (k, I (this)[k.getName ()]));
          }
        if (g) {
          e = d;
          for (h = 0; ; h++) {
        ...
        b ();
        for (f = d; !f.equals (m); )
          (g = f.getNextSourceNode ()), f.type == CKEDITOR.NODE_ELEMENT &&
            this.checkElementRemovable (f) &&
            (f.getName () == this.element
              ? z.call (this, f)
              : t (f, I (this)[f.getName ()]), g.type ==
              CKEDITOR.NODE_ELEMENT &&
              g.contains (d) &&
              (b (), (g = d.getNext ()))), (f = g);
      }
      ...
      for (var f in b)
        if (f != this.element)
          for ((c = a.getElementsByTag (f)), (e = c.count () - 1); 0 <= e; e--)
            (d = c.getItem (e)), d.isReadOnly () || t (d, b[f]);
    }
    function t (a, b, c) {
      if ((b = b && b.attributes))
    ...
    function n (a, b) {
      if (!a.hasAttributes () || b)
        if (CKEDITOR.dtd.$block[a.getName ()]) {
          ...
          (c = a.getFirst ()), (d = a.getLast ()), a.remove (!0), c &&
            (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings (), d &&
              !c.equals (d) &&
              d.type == CKEDITOR.NODE_ELEMENT &&
              d.mergeSiblings ());
    }
    ...
    function I (a) {
      ...
      if (c) {
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          'string' == typeof e
            ? (f = e.toLowerCase ())
            : ((f = e.element ? e.element.toLowerCase () : a.element), (g =
                e.attributes));
          e = b[f] || (b[f] = {});
          if (g) {
    ...
    CKEDITOR.style = function (a, b) {
      ...
      b &&
        ((a = CKEDITOR.tools.clone (a)), H (a.attributes, b), H (a.styles, b));
      c = this.element = a.element
        ? 'string' == typeof a.element ? a.element.toLowerCase () : a.element
        : '*';
      this.type =
        a.type ||
        (A[c]
          ? CKEDITOR.STYLE_BLOCK
          : M[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
    ...
    CKEDITOR.style.prototype = {
      ...
      applyToRange: function (a) {
        this.applyToRange = this.type == CKEDITOR.STYLE_INLINE
          ...
          : this.type == CKEDITOR.STYLE_BLOCK
              ? g
              : this.type == CKEDITOR.STYLE_OBJECT ? h : null;
      ...
      removeFromRange: function (a) {
        this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE
          ...
          : this.type == CKEDITOR.STYLE_BLOCK
              ? l
              : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
        ...
        switch (this.type) {
          ...
          case CKEDITOR.STYLE_INLINE:
            for (var c = a.elements, d = 0, e; d < c.length; d++)
              if (
                ((e = c[d]), this.type != CKEDITOR.STYLE_INLINE ||
  ...
  CKEDITOR.tools.extend (CKEDITOR.editor.prototype, {
    attachStyleStateChange: function (a, d) {
      ...
      b ||
        ((b = this._.styleStateChangeCallbacks = []), this.on (
          'selectionChange',
          function (a) {
            for (var d = 0; d < b.length; d++) {
              var h = b[d],
  ...
  (function () {
    ...
    CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
      ...
      h &&
        ((h = b.clone ()), b.shrink (CKEDITOR.SHRINK_TEXT, !1, {
    ...
    CKEDITOR.dom.elementPath = function (b, f) {
      ...
      do
        if (l.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !this.lastElement &&
            ((this.lastElement = l), l.is (CKEDITOR.dtd.$object) ||
          ...
          if (
            !k &&
            ((u = l.getName ()), 'true' == l.getAttribute ('contenteditable')
              ? (k = l)
              : !h && d[u] && (h = l), a[u])
          ) {
            if ((u = !h && 'div' == u)) {
    ...
    function a (a, c, d) {
      ...
      k.equals (l.getPrevious ())
        ? ((c.startOffset =
            c.startOffset -
            k.getLength () -
            a.getPrevious ().getLength ()), (k = a.getNext ()))
  ...
  (function () {
    ...
    function c (a) {
      var b = a.getById (k);
      b ||
        ((b = a.getHead ().append ('style')), b.setAttribute (
          'id',
          k
    ...
    CKEDITOR.skin = {
      ...
      getIconStyle: function (a, b, c, d, f) {
        var g;
        a &&
          ((a = a.toLowerCase ()), b && (g = this.icons[a + '-rtl']), g ||
            (g = this.icons[a]));
        a = c || (g && g.path) || '';
        d = d || (g && g.offset);
        f = f || (g && g.bgsize) || '16px';
  ...
  (function () {
    ...
    if ((a = CKEDITOR._.pending))
      for (delete CKEDITOR._.pending, (d = 0); d < a.length; d++)
        CKEDITOR.editor.prototype.constructor.apply (
          a[d][0],
          a[d][1]
        ), CKEDITOR.add (a[d][0]);
  }) (); /*
...
*/
    ...
    var b = (function () {
      return function (b, d) {
        for (var a = b.match (/[^#]./g), e = 0; 3 > e; e++) {
          ...
          c = parseInt (a[e], 16);
          c = ('0' +
            (0 > d ? 0 | (c * (1 + d)) : 0 | (c + (255 - c) * d)).toString (
              16
            )).slice (-2);
          a[f] = c;
        }
  ...
  (function () {
        ...
        if (c) {
          ...
          if (a == CKEDITOR.TRISTATE_OFF) {
            ...
            1 > e.length &&
              ...
              )), (b = h.shift ()), c.insertNode (a), a.append (
                new CKEDITOR.dom.text ('﻿', g.document)
              ), c.moveToBookmark (b), c.selectNodeContents (a), c.collapse (
                !0
            ...
            for (d = {}; (a = f.getNextParagraph ()); ) {
              ...
              c &&
                ...
                (b.push (e), CKEDITOR.dom.element.setMarker (
                  d,
                  e,
                  'blockquote_moveout',
                  !0
            ...
            e = [];
            for (d = {}; 0 < b.length; )
              (f = b.shift ()), (c = f.getParent ()), f.getPrevious ()
                ? f.getNext ()
                    ? (f.breakParent (f.getParent ()), e.push (f.getNext ()))
                    : f.remove ().insertAfter (c)
                : f.remove ().insertBefore (c), c.getCustomData (
                'blockquote_processed'
              ) ||
                (e.push (c), CKEDITOR.dom.element.setMarker (
                  d,
                  c,
                  'blockquote_processed',
                  !0
    ...
    CKEDITOR.plugins.add ('blockquote', {
      init: function (g) {
        g.blockless ||
          (g.addCommand ('blockquote', m), g.ui.addButton &&
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, b) {
        function c () {
          ...
          f &&
            ((f = this.modes[f]
              ? void 0 !== p[f] ? p[f] : CKEDITOR.TRISTATE_OFF
        ...
        var e = {
          ...
          x = CKEDITOR.tools.addFunction (function (a) {
            if (e.onkey)
              return (a = new CKEDITOR.dom.event (a)), !1 !==
        ...
        this.modes
          ? ((p = {}), a.on (
              ...
              this
            ), a.on ('activeFilterChange', c, this), a.on (
              'mode',
              c,
              this
          ...
          : d &&
              ...
              (d.on (
                ...
                this
              ), (g += d.state == CKEDITOR.TRISTATE_ON
                ? 'on'
                : d.state == CKEDITOR.TRISTATE_DISABLED ? 'disabled' : 'off'));
        var n;
        if (this.directional)
          a.on (
            'contentDirChanged',
        ...
        g = {
          ...
          iconName: n,
          label: this.label,
          cls: (this.hasArrow ? 'cke_button_expandable ' : '') +
            (this.className || ''),
          state: g,
      ...
      setState: function (a) {
        ...
        return b
          ? (b.setState (a, 'cke_button'), b.setAttribute (
              'aria-disabled',
    ...
    CKEDITOR.ui.panel.prototype = {
      ...
      showBlock: function (a) {
        ...
        var b = this._.currentBlock,
          e = !this.forceIFrame || CKEDITOR.env.ie
            ? this._.holder
      ...
      _: {
        markItem: function (a) {
          -1 != a &&
            ((a = this._
              .getItems ()
              .getItem ((this._.focusIndex = a))), CKEDITOR.env.webkit &&
              a.getDocument ().getWindow ().focus (), a.focus (), this.onMark &&
              this.onMark (a));
        },
        markFirstDisplayed: function (a) {
          for (
            ...
            if (
              ((d = e.getItem (f)), d.getAscendant (b) ||
                ((c = d), (this._.focusIndex = f)), 'true' ==
          ...
          c &&
            (a && a (), CKEDITOR.env.webkit &&
              c.getDocument ().getWindow ().focus (), c.focus (), this.onMark &&
              this.onMark (c));
        },
        getItems: function () {
      ...
      proto: {
        ...
        onKeyDown: function (a, b) {
          ...
          switch (e) {
            ...
            case 'click':
            case 'mouseup':
              return (d = this._.focusIndex), (c =
                0 <= d && this._.getItems ().getItem (d)) &&
  ...
  (function () {
    function v (a, b, c, m, h) {
      ...
      var g = f[h];
      g ||
        ((g = f[h] = new CKEDITOR.ui.panel (b, m)), (g.element = c.append (
    ...
    CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass ({
      ...
      proto: {
        ...
        showBlock: function (a, b, c, m, h, g) {
          ...
          var k = this.element,
            e = this._.iframe,
            e = CKEDITOR.env.ie && !CKEDITOR.env.edge
              ? e
          ...
          this._.blurSet ||
            ((CKEDITOR.event.useCapture = !0), e.on (
              'blur',
              function (a) {
                function u () {
              ...
              (e.on (
                ...
                this
              )), (CKEDITOR.event.useCapture = !1), (this._.blurSet = 1));
              ...
              var a = CKEDITOR.tools.bind (function () {
                ...
                q
                  ? m < c &&
                      (d = h > c
                        ? d + c
                        : b.width > c ? d - a.left : d - a.right + b.width)
                  : m < c &&
                      (d = h > c
                        ? d - c
                        : b.width > c ? d - a.right + b.width : d - a.left);
                c = a.top;
                b.height - a.top < e &&
                  (p = c > e
                    ? p - e
                    : b.height > e ? p - a.bottom + b.height : p - a.top);
                CKEDITOR.env.ie &&
                  !CKEDITOR.env.edge &&
                  ((b = a =
                    k.$.offsetParent &&
                    ...
                    'html' == b.getName () &&
                    (b = b.getDocument ().getBody ()), b &&
                    'rtl' == b.getComputedStyle ('direction') &&
                    (d = CKEDITOR.env.ie8Compat
                      ? d -
                          2 *
                            k.getDocument ().getDocumentElement ().$.scrollLeft
        ...
        showAsChild: function (a, b, c, f, h, g) {
          if (
            ...
            }, this)), (this._.activeChild = a), (this._.focused = !1), a.showBlock (
              b,
              c,
              f,
              h,
              g
            ), this.blur (), (CKEDITOR.env.ie7Compat ||
        ...
        hideChild: function (a) {
          ...
          b &&
            (delete b.onHide, delete this._.activeChild, b.hide (), a &&
              this.focus ());
        },
      },
    });
  ...
  CKEDITOR.plugins.add ('colorbutton', {
    ...
    init: function (d) {
      function w (a) {
        var u = a.name, f = a.type, h = a.title, v = a.order, t = a.commandName;
        a = a.contentTransformations || {};
        var p = new CKEDITOR.style (k['colorButton_' + f + 'Style']),
          q = CKEDITOR.tools.getNextId () + '_colorBox',
          r = {type: f},
          l = new CKEDITOR.style (k['colorButton_' + f + 'Style'], {
            color: 'inherit',
          }),
          n;
        d.addCommand (t, {
        ...
        d.ui.add (u, CKEDITOR.UI_PANELBUTTON, {
          ...
          select: function (a) {
            ...
            a = CKEDITOR.tools.array.find (b, a);
            a = m (a);
            x (n, a);
            n._.markFirstDisplayed ();
          },
          onBlock: function (a, b) {
            ...
            b.element.setHtml (
              B ({type: f, colorBoxId: q, colorData: r, commandName: t})
            );
            b.element.getDocument ().getBody ().setStyle ('overflow', 'hidden');
            CKEDITOR.ui.fire ('ready', this);
            var c = b.keys, e = 'rtl' == d.lang.dir;
            c[e ? 37 : 39] = 'next';
            c[40] = 'next';
            c[9] = 'next';
            c[e ? 39 : 37] = 'prev';
          ...
          onOpen: function () {
            ...
            do
              c =
                (b &&
                  b.getComputedStyle (
                    'back' == f ? 'background-color' : 'color'
                  )) ||
                'transparent';
            while (
              'back' == f && 'transparent' == c && b && (b = b.getParent ())
            );
            ...
            if ((b = a && a.getRanges ()[0])) {
              for (
                var a = new CKEDITOR.dom.walker (b),
                  e = b.collapsed ? b.startContainer : a.next (),
                  b = '';
                e;
              ...
              'transparent' == b && (b = '');
              'fore' == f && (r.automaticTextColor = '#' + m (c));
              r.selectionColor = b ? '#' + b : '';
              x (n, b);
            }
            return c;
          },
      ...
      function B (a) {
        function u (a) {
          a = a && new CKEDITOR.style (n, {color: a});
          d.execCommand (t, {newStyle: a});
        }
        var f = a.type, h = a.colorBoxId, v = a.colorData, t = a.commandName;
        a = [];
        var p = k.colorButton_colors.split (','),
          q = k.colorButton_colorsPerRow || 6,
          r = d.plugins.colordialog && !1 !== k.colorButton_enableMore,
          l = p.length + (r ? 2 : 1),
          n = d.config['colorButton_' + f + 'Style'];
        n.childRule = 'back' == f
          ? function (a) {
              return y (a);
            }
          : function (a) {
              return (
                !(a.is ('a') || a.getElementsByTag ('a').count ()) || y (a)
              );
            };
        ...
        for (h = 0; h < p.length; h++) {
          0 === h % q && a.push ('\x3c/tr\x3e\x3ctr\x3e');
          var b = p[h].split ('/'), c = b[0], e = b[1] || c;
          a.push (
            '\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',
            b[1] ? c : d.lang.colorbutton.colors[e] || e,
            '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(',
            m,
            ",'",
            e,
      ...
      function x (a, d) {
        for (var f = a._.getItems (), h = 0; h < f.count (); h++) {
          var g = f.getItem (h);
          g.removeAttribute ('aria-selected');
          d &&
            d == m (g.getAttribute ('data-value')) &&
      ...
      if (!CKEDITOR.env.hc) {
        ...
        var z, A = d.config.colorButton_normalizeBackground;
        if (void 0 === A || A)
          z = [
            [
              {
                ...
                right: function (a) {
                  var g = new CKEDITOR.style (d.config.colorButton_backStyle, {
                    color: a.styles.background,
                  }).getDefinition ();
                  a.name = g.element;
                  a.styles = g.styles;
                  a.attributes = g.attributes || {};
                  return a;
                },
              },
            ],
        ...
        w ({
          ...
          type: 'back',
          commandName: 'bgColor',
          title: g.bgColorTitle,
          order: 20,
          contentTransformations: z,
        });
      }
    },
  });
  ...
  CKEDITOR.plugins.add ('dialogui', {
    onLoad: function () {
                ...
                function () {
                  for (
                    var e = [],
                      d = [],
                      g =
                        (a.id ? a.id : CKEDITOR.tools.getNextId ()) + '_radio',
                      k = 0;
                    k < a.items.length;
                    k++
                  ) {
            ...
            if (!(3 > arguments.length)) {
              ...
              c.onClick = function (c) {
                ...
                !1 !== c &&
                  ('xhr' !== c &&
                    b
                      .getContentElement (d[0], d[1])
                      .submit (), this.disable ());
              };
              b.on ('load', function () {
                b
                  .getContentElement (a['for'][0], a['for'][1])
                  ._.buttons.push (f);
              });
      ...
      CKEDITOR.ui.dialog.textarea.prototype = new CKEDITOR.ui.dialog
        .textInput ();
      ...
      CKEDITOR.ui.dialog.fileButton.prototype = new CKEDITOR.ui.dialog
        .button ();
      ...
      CKEDITOR.dialog.addUIElement ('fieldset', {
        build: function (b, a, d) {
          for (
            ...
            e.push (k);
            h.push (
              CKEDITOR.dialog._.uiElementBuilders[c.type].build (b, c, k)
            );
          }
    ...
    function ba (a) {
      ...
      a.parts.title.on (
        ...
        function (g) {
          ...
          d = a.getPosition ();
          CKEDITOR.env.ie6Compat &&
            ((f = u.getChild (0).getFrameDocument ()), f.on (
              'mousemove',
              b
            ), f.on ('mouseup', c));
      ...
      f
        ...
        : ((d = [
            ...
            ((e =
              ...
              e +
              ";\\'\x3e\x3c/body\x3e\x3c/html\x3e"), d.push (
            ...
            d.join ('')
          )), f.setOpacity (void 0 !== c ? c : 0.5), f.on ('keydown', J), f.on (
            'keypress',
            J
          ), f.on ('keyup', J), f.appendTo (CKEDITOR.document.getBody ()), (D[
            b
          ] = f));
      ...
      function d (b) {
        if (n == CKEDITOR.dialog._.currentTop) {
          ...
          if (9 == c || c == CKEDITOR.SHIFT + 9)
            ...
            (c = -1 != CKEDITOR.tools.indexOf ([d ? 39 : 37, 38], c)
              ? A.call (n)
              : V.call (n)), n.selectPage (c), n._.tabs[c][0].focus (), (q = 1);
          else if ((13 != c && 32 != c) || !n._.tabBarMode)
            if (13 == c)
              (c = b.data.getTarget ()), c.is (
                'a',
                'button',
                'select',
                'textarea'
                ...
                ((c = this.getButton ('ok')) &&
                  CKEDITOR.tools.setTimeout (c.click, 0, c), (q = 1)), (l = 1);
            else if (27 == c)
            ...
            this.selectPage (
              this._.currentTabId
            ), (this._.tabBarMode = !1), (this._.currentFocusIndex = -1), e (
              1
            ), (q = 1);
          f (b);
        }
      ...
      this.on (
        ...
        function () {
          ...
          a.config.dialog_startupFocusTab && b
            ? ((n._.tabBarMode = !0), n._.tabs[
                n._.currentTabId
              ][0].focus (), (n._.currentFocusIndex = -1))
            : this._.hasFocus ||
                ((this._.currentFocusIndex = b
                  ? -1
                  : this._.focusList.length - 1), g.onFocus
    ...
    CKEDITOR.dialog.prototype = {
      ...
      show: function () {
        ...
        null === CKEDITOR.dialog._.currentTop
          ...
          : ((this._.parentDialog =
              CKEDITOR.dialog._.currentTop), (c = this._.parentDialog
              .getElement ()
              .getFirst ()), (c.$.style.zIndex -= Math.floor (
              e / 2
            )), this._.parentDialog
              .getElement ()
              .setStyle (
      ...
      addPage: function (a) {
        if (
          ...
          for (
            ...
            e.notAllowed || 'hbox' == e.type || 'vbox' == e.type || g++, (d[
              e.id
            ] = e), 'function' == typeof e.getChild &&
              f.push.apply (f, e.getChild ());
          g || (a.hidden = !0);
      ...
      selectPage: function (a) {
        if (
          ...
          for (var b in this._.tabs) {
            ...
            b != a &&
              (c.removeClass ('cke_dialog_tab_selected'), c.removeAttribute (
                'aria-selected'
              ), e.hide ());
          ...
          CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat
            ? (K (d[1]), d[1].show (), setTimeout (function () {
                K (d[1], 1);
              }, 0))
            : d[1].show ();
          this._.currentTabId = a;
      ...
      hidePage: function (a) {
        ...
        b &&
          ...
          (a == this._.currentTabId &&
            this.selectPage (A.call (this)), b.hide (), this._
            .pageCount--, this.updateStyle ());
      },
      showPage: function (a) {
      ...
      addFocusable: function (a, b) {
        if ('undefined' == typeof b)
          (b = this._.focusList.length), this._.focusList.push (
            new L (this, a, b)
          );
        else {
      ...
      getModel: function (a) {
        return this._.model
          ? this._.model
          : this.definition.getModel ? this.definition.getModel (a) : null;
      },
      setModel: function (a) {
        this._.model = a;
      },
      ...
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, e, d, f, g) {
          if (!(4 > arguments.length)) {
            ...
            r = (b.style || '').split (';');
            b.align &&
              ((n = b.align), (m['margin-left'] = 'left' == n ? 0 : 'auto'), (m[
                'margin-right'
              ] = 'right' == n ? 0 : 'auto'));
            for (l in m)
              r.push (l + ':' + m[l]);
            ...
            a.on ('load', function () {
              ...
              if (b) {
                var c = t.type in {checkbox: 1, ratio: 1} &&
                  CKEDITOR.env.ie &&
                  8 > CKEDITOR.env.version
      ...
      var a = {
        build: function (a, c, e) {
          for (
            ...
            g.push (m);
            h.push (
              CKEDITOR.dialog._.uiElementBuilders[f.type].build (a, f, m)
            );
          }
    ...
    CKEDITOR.tools.extend (CKEDITOR.editor.prototype, {
      openDialog: function (a, b, c) {
        ...
        if ('function' == typeof d)
          (d = this._.storedDialogs || (this._.storedDialogs = {})), (e =
            d[a] || (d[a] = new CKEDITOR.dialog (this, a))), e.setModel (
            c
          ), b && b.call (e, e), e.show ();
        else {
          if ('failed' == d)
    ...
    function m (a) {
      a.sort (function (a, f) {
        return a.group < f.group
          ...
          : a.group > f.group
              ? 1
              : a.order < f.order ? -1 : a.order > f.order ? 1 : 0;
      });
    }
    var k =
          ...
          if ((f = f.getItems && f.getItems ())) {
            b
              ...
              : ((b = this._.subMenu = new CKEDITOR.menu (
                ...
                )), (b.parent = this), (b._.onClick = CKEDITOR.tools.bind (
                  this._.onClick,
                  this
                )));
            for (var c in f) {
      ...
      proto: {
        render: function (a, b, f) {
          var k = a.id + String (b),
            ...
            e,
            d,
            m = h == CKEDITOR.TRISTATE_ON
              ? 'on'
              : h == CKEDITOR.TRISTATE_DISABLED ? 'disabled' : 'off';
          ...
          this.command &&
            ((e = g.getCommand (this.command)), (e = g.getCommandKeystroke (
              e
            )) &&
        ...
        proto: {
          ...
          open: function (a, f, c, d) {
            !1 !== this.editor.config.enableContextMenu &&
              ...
              (this.editor.focus (), (a =
                a ||
                CKEDITOR.document.getDocumentElement ()), this.editor.selectionChange (
                1
              ), this.show (a, f, c, d));
          },
        },
  ...
  (function () {
    ...
    function l (a, c, b) {
      ...
      this.lang = a.lang;
      'string' === typeof c
        ? ((this.data = c), (this.file = n (
            this.data
          )), (this.loaded = this.total = this.file.size))
        : ((this.data = null), (this.file = c), (this.total = this.file.size), (this.loaded = 0));
      b
        ? (this.fileName = b)
        : this.file.name
            ? (this.fileName = this.file.name)
            : ((a = this.file.type.split ('/')), d &&
                (a[0] = d), (this.fileName = a.join ('.')));
      this.uploaded = 0;
        ...
        a.on (
          ...
          function (a) {
            ...
            try {
              ...
              (f.message =
                b.lang.filetools.responseError), CKEDITOR.warn (
    ...
    l.prototype = {
      ...
      upload: function (a, c) {
        var b = c || {};
        a
          ? ((this.uploadUrl = a), (this.xhr = new XMLHttpRequest ()), this.attachRequestListeners (), this.editor.fire (
              'fileUploadRequest',
              {fileLoader: this, requestData: b}
            ) && this.changeStatus ('uploading'))
          : ((this.message = this.lang.filetools.noUrlError), this.changeStatus (
              'error'
            ));
      },
      attachRequestListeners: function () {
        function a () {
          'error' != b.status &&
            ((b.message = b.lang.filetools.networkError), b.changeStatus (
              'error'
            ));
        }
        function c () {
        ...
        d.upload
          ? ((d.upload.onprogress = function (a) {
              a.lengthComputable &&
                (b.uploadTotal || (b.uploadTotal = a.total), (b.uploaded =
                  a.loaded), b.update ());
            }), (d.upload.onerror = a), (d.upload.onabort = c))
        ...
        d.onload = function () {
          ...
          if ('abort' != b.status)
            if (
              ...
              (b.message =
                b.lang.filetools['httpError' + d.status]), b.message ||
    ...
    CKEDITOR.tools.extend (CKEDITOR.fileTools, {
      ...
      isFileUploadSupported: 'function' === typeof FileReader &&
        ...
        for (var e, g = c.length; g--; )
          if (
            ((e = c[g]), ('hbox' != e.type &&
              'vbox' != e.type &&
              'fieldset' != e.type) ||
              l (a, b, d, e.children), e.filebrowser)
          )
            if (
              ...
              void 0 === f &&
                ((f = a.config['filebrowser' + k (b) + 'BrowseUrl']), void 0 ===
              ...
              ((f = e.filebrowser.url), void 0 === f &&
                ((f = a.config['filebrowser' + k (b) + 'UploadUrl']), void 0 ===
                  f && (f = a.config.filebrowserUploadUrl)), f)
            ) {
              var h = e.onClick;
              ...
              u (
                a,
                d.getContents (e['for'][0]).get (e['for'][1]),
                e.filebrowser
              );
            }
    }
    ...
    function m (a, b) {
      ...
      if ('function' != typeof b || !1 !== b.call (this._.filebrowserSe))
        if (!e || !1 !== e.call (this._.filebrowserSe, a, b))
          if (
            ('string' == typeof b && b && alert (b), a &&
              ((c = this._.filebrowserSe), (d = c.getDialog ()), (c =
                c.filebrowser.target || null)))
          )
    ...
    CKEDITOR.on ('dialogDefinition', function (a) {
      if (a.editor.plugins.filebrowser)
        for (var b = a.data.definition, d, c = 0; c < b.contents.length; ++c)
          if ((d = b.contents[c]))
            l (a.editor, a.data.name, b, d.elements), d.hidden &&
              d.filebrowser &&
      ...
      CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass ({
        ...
        proto: {
          ...
          showAll: function () {
            ...
            for (var e in b)
              (a = c.getById (b[e])), (d = a.getNext ()), a.setStyle (
                'display',
                ''
  ...
  (function () {
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass ({
      ...
      proto: {
        ...
        commit: function () {
          this._.committed ||
            (this._.list.commit (), (this._.committed = 1), CKEDITOR.ui.fire (
              'ready',
              this
            ));
          this._.committed = 1;
        ...
        disable: function () {
          this._.state != CKEDITOR.TRISTATE_DISABLED &&
            ((this._.lastState = this._.state), this.setState (
              CKEDITOR.TRISTATE_DISABLED
            ));
        },
        destroy: function () {
  ...
  (function () {
        ...
        exec: function (a, b) {
          ...
          if (d || c)
            if ((d && e.collapsed && m ({editor: a, range: e, style: d}), f))
              ...
              if ((e = d))
                (e = d instanceof CKEDITOR.style && c instanceof CKEDITOR.style
              ...
              [
                {
                  ...
                  right: function (a) {
                    ...
                    a.name = 'span';
                    a.attributes.size &&
                      ((a.styles['font-size'] = b[a.attributes.size]), delete a
                        .attributes.size);
                    a.attributes.align &&
                      ((a.styles['text-align'] = a.attributes.align), delete a
                        .attributes.align);
                    a.attributes.face &&
                      ((a.styles['font-family'] = a.attributes.face), delete a
                        .attributes.face);
                  },
                },
              ],
    ...
    function m (a) {
      var b = a.editor, c = a.range, d = a.style, e, f, g;
      e = b.elementPath ();
      if (
        ...
        if (f && g) {
          for (f = c.createBookmark (); (e = a.getFirst ()); )
            e.insertBefore (a);
          a.remove ();
          c.moveToBookmark (f);
        } else
          f || g
            ...
            : (c.splitElement (a), c.moveToPosition (
                a,
                CKEDITOR.POSITION_AFTER_END
    ...
    var l = CKEDITOR.tools.createClass ({
      $: function (a) {
        ...
        for (var c = 0; c < b.length; c++) {
          var d = b[c], e, f;
          d
            ? ((d = d.split ('/')), (e = d[0]), (d = d[1]), (f = {}), (f[
                a.styleVariable
              ] =
                d || e), (this._.data[e] = new CKEDITOR.style (
                a.styleDefinition,
                f
              )), (this._.data[e]._.definition.name = e), this._.names.push (e))
            : (b.splice (c, 1), c--);
        }
      },
      proto: {
      ...
      if (!a.blockless) {
        for (
          ...
          if (!a.filter.customConfig || a.filter.check (k))
            m++, (d[h] = k), (d[h]._.enterMode = a.config.enterMode), n.push (
              k
            );
        }
        0 !== m &&
    ...
    CKEDITOR.plugins.add ('indent', {
      init: function (a) {
        ...
        a.on ('dirChanged', function (b) {
          ...
          f.setStartBefore (l);
          f.setEndAfter (l);
          for (var n = new CKEDITOR.dom.walker (f), c; (c = n.next ()); ) if (
              c.type == CKEDITOR.NODE_ELEMENT
            )
      ...
      registerCommands: function (a, b) {
        a.on ('pluginsLoaded', function () {
          for (var a in b) (function (a, b) {
              ...
              for (c in b.jobs) e.on (
                  'exec',
                  function (d) {
                    d.data.done ||
                      (a.fire ('lockSnapshot'), b.execJob (a, c) &&
                        (d.data.done = !0), a.fire (
                        'unlockSnapshot'
      ...
      function g (b) {
        ...
        if (r && r.length)
          for (a = 0; a < r.length; a++) {
            for (
              l = b = r[a];
              (l = l.getNext ()) && l.is && l.getName () in p;

            )
              CKEDITOR.env.needsNbspFiller &&
                !b.getFirst (x) &&
                b.append (c.document.createText (' ')), b.append (l);
            b.insertAfter (t);
          }
      ...
      for (
        ...
        if (!b) {
          ...
          d &&
            d.type == CKEDITOR.NODE_ELEMENT &&
            d.getName () in p &&
            (c.setStartAt (d, CKEDITOR.POSITION_AFTER_START), c.setEndAt (
              d,
              CKEDITOR.POSITION_BEFORE_END
            ), (b = d));
        }
        b &&
          ...
          ((d = new CKEDITOR.dom.walker (
            c
          )), (d.evaluator = n), (c.startContainer = d.next ()));
        b &&
          c.endContainer.type == CKEDITOR.NODE_ELEMENT &&
          c.endContainer.getName () in p &&
          ((d = new CKEDITOR.dom.walker (
            c
          )), (d.evaluator = n), (c.endContainer = d.previous ()));
        if (b) return g (b);
      }
      return 0;
    }
      ...
      exec: function (a) {
        ...
        if (c) {
          for (
            ...
            for (
              (h = d[n].createIterator ()), (h.enlargeBr =
                b != CKEDITOR.ENTER_BR);
                ...
                if ((l = a.activeFilter.check (l + '(' + e + ')')) || p) {
                  ...
                  var m =
                    ...
                    r =
                      ...
                      (!k || q (g, !0) != this.value);
                  e && l
                    ? r ? g.addClass (e) : m || g.removeAttribute ('class')
  ...
  (function () {
    ...
    CKEDITOR.editor.prototype.createFakeElement = function (a, b, c, d) {
      ...
      d &&
        ((b['data-cke-resizable'] = d), (c = new k ()), (d = a.getAttribute (
          'width'
        )), (a = a.getAttribute ('height')), d && (c.rules.width = h (d)), a &&
    ...
    CKEDITOR.editor.prototype.createFakeParserElement = function (a, b, c, d) {
      ...
      c && (b['data-cke-real-element-type'] = c);
      d &&
        ((b['data-cke-resizable'] = d), (d = a.attributes), (a = new k ()), (c =
          d.width), (d = d.height), void 0 !== c &&
          (a.rules.width = h (c)), void 0 !== d &&
          (a.rules.height = h (d)), a.populate (b));
  ...
  (function () {
    ...
    function r (c, b) {
      for (
        ...
        (f = e[g].toLowerCase ()), (d = b[f]), 0 < g && a.push (','), a.push (
          "'",
          d ? p (encodeURIComponent (b[f])) : '',
          "'"
        );
      a.push (')');
      return a.join ('');
    ...
    CKEDITOR.plugins.link = {
      getSelectedLink: function (c, b) {
        ...
        for (e = 0; e < f.length; e++)
          if (
            ((g = a.getRanges ()[e]), g.shrink (CKEDITOR.SHRINK_ELEMENT, !0, {
              skipBogus: !0,
            }), (g = c
              .elementPath (g.getCommonAncestor ())
              .contains ('a', 1)) && b)
          )
            d.push (g);
          else if (g) return g;
      ...
      parseLinkAttributes: function (c, b) {
                ...
                a.replace (B, function (a, b, c) {
                  if (b == e.name) {
                    ...
                    for (var f = c.length, g, h, k = 0; k < f; k++)
                      (g = decodeURIComponent), (h = c[k]
                        .replace (b, '')
                        .replace (/\\'/g, "'")), (h = g (h)), (g = e.params[
                        k
                      ].toLowerCase ()), (a[g] = h);
        ...
        if (!d.type)
          if ((f = a.match (x)))
            (d.type = 'anchor'), (d.anchor = {}), (d.anchor.name = d.anchor.id =
              f[1]);
            ...
            a &&
              (g = a.match (y)) &&
              ((d.type = 'url'), (d.url = {}), (d.url.protocol =
                g[1]), (d.url.url = g[2]));
        if (b) {
          ...
          case 'email':
            ...
            switch (a) {
              ...
              case 'encode':
                ...
                break;
              default:
                (a = f.split ('@', 2)), (d.name = a[0]), (d.domain =
                  a[1]), (a = ['javascript:', r (c, d)]);
            }
  ...
  (function () {
    function K (a, l, d, f) {
      for (
        ...
        (h = h.getAscendant ('li', !0)) &&
          ...
          (g.push (h), CKEDITOR.dom.element.setMarker (
            d,
            h,
            'list_item_processed',
            !0
      ...
      for (var h = l.root.getDocument (), k, c, b = 0; b < g.length; b++) {
        ...
        k = e[p].parent;
        k.is (this.type) ||
          ((c = h.createElement (this.type)), k.copyAttributes (c, {
            start: 1,
            type: 1,
    ...
    function L (a, l, d) {
      ...
      if (!(1 > g.length)) {
        ...
        for (d.push (b); g.length; )
          (d = g.shift ()), (a = e.createElement ('li')), (c = d), c.is (
            'pre'
          ) ||
            M.test (c.getName ()) ||
            'false' == c.getAttribute ('contenteditable')
            ? d.appendTo (a)
            : (d.copyAttributes (a), h &&
                d.getDirection () &&
                (a.removeStyle ('direction'), a.removeAttribute (
                  'dir'
                )), d.moveChildren (a), d.remove ()), a.appendTo (b);
    ...
    function N (a, l, d) {
      function f (b) {
        if (
          ...
          a.document.createElement ('br')[b ? 'insertBefore' : 'insertAfter'] (
            c
          );
      }
      for (
    ...
    function F (a, l, d, f) {
      for (var e, g; (e = a[f ? 'getLast' : 'getFirst'] (O)); )
        (g = e.getDirection (1)) !== l.getDirection (1) &&
          e.setAttribute ('dir', g), e.remove (), d
          ? e[f ? 'insertBefore' : 'insertAfter'] (d)
          : l.append (e, f), (d = e);
    }
    function G (a) {
      function l (d) {
    ...
    function D (a, l, d) {
      ...
      for (; d.checkStartOfBlock () && d.checkEndOfBlock (); ) {
        ...
        if (!f) break;
        f.is ('li') &&
          ((g = f.getParent ()), f.equals (g.getLast (t)) &&
            f.equals (g.getFirst (t)) &&
            (f = g));
      ...
      listToArray: function (a, l, d, f, e) {
        ...
        for (var g = 0, b = a.getChildCount (); g < b; g++) {
          ...
          if ('li' == h.$.nodeName.toLowerCase ()) {
            ...
            e
              ? (k.grandparent = e)
              : ((k.grandparent = a.getParent ()), k.grandparent &&
      ...
      arrayToList: function (a, l, d, f, e) {
        ...
        for (
          ...
          if (q.indent == p) {
            (k && a[c].parent.getName () == k.getName ()) ||
              ((k = a[c].parent.clone (!1, 1)), e &&
                k.setAttribute ('dir', e), h.append (k));
            ...
            (q = a[c - 1].element.getDirection (
              ...
              CKEDITOR.env.needsNbspFiller &&
              7 >= b.$.documentMode &&
              m.append (b.createText (' ')), m.append (c.listNode), (c =
              c.nextIndex);
          else if (-1 == q.indent && !d && g) {
            u[g.getName ()]
              ? ((m = q.element.clone (!1, !0)), n != g.getDirection (1) &&
                  m.setAttribute ('dir', n))
            ...
            for (g = 0; g < z; g++)
              if (((v = q.contents[g]), I (v) && 1 < z))
                ...
                J
                  ? (r ||
                      ((r = b.createElement (y)), m.append (r), k &&
                        r.setAttribute ('dir', n)), E &&
                      r.setAttribute ('style', E), B &&
                      r.setAttribute ('class', B), x &&
                      (r.append (x), (x = null)), r.append (v.clone (1, 1)))
                  : m.append (v.clone (1, 1));
        ...
        if (l)
          for (a = h.getFirst (); a; ) {
            if (
              a.type == CKEDITOR.NODE_ELEMENT &&
              (CKEDITOR.dom.element.clearMarkers (l, a), a.getName () in
                CKEDITOR.dtd.$listItem &&
    ...
    C.prototype = {
      exec: function (a) {
        ...
        for (
          ...
          for (
            ...
            if (!m.getCustomData ('list_block') && !f (m)) {
              ...
              r ||
                ((r = y), r.getCustomData ('list_group_object_' + p)
        ...
        for (q = []; 0 < h.length; )
          (n = h.shift ()), this.state == CKEDITOR.TRISTATE_OFF
            ? l (n) ||
                (u[n.root.getName ()]
                  ? K.call (this, a, n, c, q)
                  : L.call (this, a, n, q))
      ...
      refresh: function (a, l) {
        var d = l.contains (u, 1), f = l.blockLimit || l.root;
        d && f.contains (d)
          ? this.setState (
    ...
    CKEDITOR.plugins.add ('list', {
      ...
      init: function (a) {
        a.blockless ||
          (a.addCommand (
            'numberedlist',
            new C ('numberedlist', 'ol')
          ), a.addCommand ('bulletedlist', new C ('bulletedlist', 'ul')), a.ui
            .addButton &&
              ...
              if (e && e.collapsed) {
                ...
                if (b) {
                  ...
                  (c = g.contains (u)) &&
                    ...
                    c.is ('li') &&
                    (c = A (c))
                    ? ((f = c), (c = c.getPrevious (t)), d.moveToPosition (
                        c && z (c) ? c : f,
                        CKEDITOR.POSITION_BEFORE_START
                      ))
                    : (k.range.setStartAt (
                        ...
                        (c.is ('li') ||
                          (k.range.selectNodeContents (
                            c
                          ), k.reset (), (k.evaluator = H), (c = k.previous ())), (f = c), d.moveToElementEditEnd (
                          f
                        ), d.moveToPosition (
                          d.endPath ().block,
                          CKEDITOR.POSITION_BEFORE_END
                  ...
                  if (f) D (a, d, e), l.cancel ();
                    ...
                    p &&
                      ...
                      ((f = p.getFirst (t)), e.checkBoundaryOfElement (
                        f,
                        CKEDITOR.START
                      ) &&
                        ((c = p.getPrevious (t)), A (f)
                  ...
                  if (
                    (k.range.setEndAt (
                      ...
                      c.equals (h)
                      ? ((g = 1), (c = k.next ()))
                      : e.checkBoundaryOfElement (b, CKEDITOR.END) &&
                          (g = 2), g && c)
                  ) {
                    e = e.clone ();
                    ...
                    if (
                      1 == g &&
                      (d.optimize (), !d.startContainer.equals (f))
                    ) {
                  ...
                  k.range.setEndAt (
                    ...
                    ((c = c.getFirst (t)), g.block &&
                      ...
                      : A (c)
                          ...
                          : ((e = e.clone ()), e.moveToElementEditStart (c), D (
                              a,
                              d,
                              e
                            )), l.cancel ());
  ...
  (function () {
        ...
        place: function () {
          ...
          p.equals (c)
            ...
            : ((m.left =
                ...
                b.scroll.x), (m.right = ''));
          h && g
            ? (m.top = h.size.margin.bottom === g.size.margin.top
          ...
          d.is (C) || q (m.top, b.scroll.y - 15, b.scroll.y + 5)
            ...
            : d.is (D) || q (m.top, b.pane.bottom - 5, b.pane.bottom + 15)
                ? ((m.top = a.inInlineMode
                    ...
                    : b.pane.bottom - 1), this.look (D))
                : (a.inInlineMode &&
                    (m.top -=
                      b.editable.top + b.editable.border.top), this.look (x));
          a.inInlineMode &&
            (m.top--, (m.top += b.editable.scroll.top), (m.left +=
              b.editable.scroll.left));
          for (var n in m)
    ...
    function S (a, c, d) {
      ...
      t.ie && a.enterMode == CKEDITOR.ENTER_BR
        ...
        : ((f =
            ...
            a.enterMode), (f = new R (K[f], a.doc)), f.is ('br') ||
            a.doc.createText (J).appendTo (f));
    ...
    function u (a) {
      ...
      (c = ba (a)) ||
        (n (a)
          ? ((c = {left: 1, right: 1, center: 1}), (c = !(!c[
              a.getComputedStyle ('float')
    ...
    function ca (a) {
      ...
      return !f && 0 <= c.size.top && q (d.y, 0, c.size.top + e)
        ? ((a = a.inInlineMode || 0 === b.scroll.y ? C : x), new z ([
            null,
            c,
            I,
            M,
    ...
    function U (a, c, d, b) {
      for (
        ...
        (f[y[l]] =
          ...
          parseInt (c.getComputedStyle.call (c, 'padding-' + y[l]), 10) ||
          0), (k[y[l]] =
          ...
          function () {
            ...
            d.is (B.$inline) ||
              (b.inInlineMode &&
                ...
                b.hiddenMode = 0;
                b.mouseDown = 0;
              }), a.addCommand ('accessPreviousSpace', Y (b)), a.addCommand (
                'accessNextSpace',
                Y (b, !0)
              ), a.setKeystroke ([
                ...
                for (f in {
                  ...
                  br: 1,
                  div: 1,
                }) for ((c = a.document.getElementsByTag (f)), (e = c.count ()); e--; ) if (
                      (d = c.getItem (e)).data ('cke-magicline-hot')
                    ) {
                      b.hotNode = d;
                      b.lastCmdDirection = 'true' ===
                        d.data ('cke-magicline-dir')
                        ? !0
                        : !1;
                      return;
                    }
      ...
      ia = (function () {
        function a (a) {
          ...
          for (
            ...
            (h = Math.abs (ka (a, e, g) - a.mouse.y)), h < b &&
              ((b = h), (l = e), (p = g)), (e = g), r (a, e);
  ...
  (function () {
    function n (a) {
      ...
      for (var e = [], f = ['style', 'className'], b = 0; b < f.length; b++) {
        ...
        c &&
          ((c = new CKEDITOR.dom.element (c)), e.push ([
            c,
            c.nextSibling,
          ]), c.remove ());
      }
    ...
    function v (a) {
      if (!a.editable ().isInline ()) {
        ...
        for (f in e) {
          ...
          'wysiwyg' != b.mode ||
            b.readOnly ||
            ((b = b.document.getBody ()), b.setAttribute (
              'contentEditable',
              !1
            ...
            exec: function () {
              ...
              if (this.state == CKEDITOR.TRISTATE_OFF) {
                ...
                for (d = a.container; (d = d.getParent ()); )
                  d.setCustomData ('maximize_saved_styles', r (d)), d.setStyle (
                    'z-index',
                ...
                for (var d = [g, h], q = 0; q < d.length; q++)
                  u (d[q], d[q].getCustomData ('maximize_saved_styles')), d[
                    q
              ...
              if ((d = this.uiItems[0]))
                (g = this.state == CKEDITOR.TRISTATE_OFF
                  ? f.maximize.maximize
                  : f.maximize.minimize), (d = CKEDITOR.document.getById (
                  d._.id
                )), d.getChild (1).setHtml (g), d.setAttribute (
                  'title',
                  g
              ...
              'wysiwyg' == a.mode
                ? l
                    ...
                    : c.$.scrollTo (m.x, m.y)
                : (l &&
                    ((k.selectionStart = l[0]), (k.selectionEnd =
                      l[1])), (k.scrollLeft = m[0]), (k.scrollTop = m[1]));
              l = m = null;
              n = this.state;
  ...
  CKEDITOR.plugins.add ('resize', {
    init: function (b) {
      function f (d) {
        ...
        h &&
          (e = Math.max (a.resize_minWidth, Math.min (f, a.resize_maxWidth)));
        p &&
        ...
        exec: function (d) {
          if (d.editable ().hasFocus) {
            ...
            if (
              ...
              if (a || c)
                if (a)
                  (a = new CKEDITOR.dom.element (a)), e.moveToElementEditStart (
                    a
                  ), (e.checkStartOfBlock () && e.checkEndOfBlock ()) ||
  ...
  (function () {
    function q (d, f) {
      function b (a) {
        return f
          ? f.contains (a) && a.getAscendant ('table', !0).equals (f)
          : !0;
      }
      function c (a) {
        var b = /^(?:td|th)$/;
        0 < e.length ||
          ...
          (CKEDITOR.dom.element.setMarker (h, a, 'selected_cell', !0), e.push (
            a
          ));
      }
      var e = [], h = {};
      ...
      for (var a = d.getRanges (), k = 0; k < a.length; k++) {
        ...
        if (g.collapsed)
          ...
          var g = new CKEDITOR.dom.walker (g), m;
    ...
    function r (d, f) {
      for (
        ...
        1 < e[k].rowSpan && a && e[k] == a[k]
          ? ((g = e[k]), (g.rowSpan += 1))
          : ((g = new CKEDITOR.dom.element (e[k]).clone ()), g.removeAttribute (
              'rowSpan'
            ), g.appendBogus (), c.append (g), (g = g.$));
        k += g.colSpan - 1;
      }
            ...
            1 == l.$.rowSpan
              ...
              : (--l.$.rowSpan, n == d &&
                  ((n = e[d + 1]), n[m - 1]
                    ...
                    : new CKEDITOR.dom.element (c.$.rows[d + 1]).append (
                        l,
                        1
                      )));
            m += l.$.colSpan - 1;
      ...
      for (g = 0; g < k; g++)
        c[g] &&
          (1 < c[g].colSpan && e[g] == c[g]
            ...
            : ((h = new CKEDITOR.dom.element (
                c[g]
              )), (a = h.clone ()), a.removeAttribute (
                'colSpan'
              ), a.appendBogus (), a[f ? 'insertBefore' : 'insertAfter'].call (
                a,
                h
              ), b.push (a), (a = a.$)), (g += a.rowSpan - 1));
      return b;
    }
    function y (d) {
      function f (a) {
        ...
        for (
          (d = c.getPrevious ()) ||
          (d = c.getParent ().getPrevious ().getLast ());
      ...
      for (l = k; l <= g; l++)
        for (n = 0; n < a.length; n++)
          (h = a[n]), (e = new CKEDITOR.dom.element (
            c.$.rows[n]
          )), (h = new CKEDITOR.dom.element (h[l])), h.$ &&
            (1 == h.$.colSpan ? h.remove () : --h.$.colSpan, (n +=
              h.$.rowSpan - 1), e.$.cells.length || m.push (e));
      k = a[0].length - 1 > g
    ...
    function x (d, f, b) {
      ...
      for (f = 0; f < c.length; f++) {
        ...
        b ||
          ((v = l), (z = v.getBogus ()) &&
            z.remove (), v.trim (), l.getChildren ().count () &&
            (t == r ||
              !y ||
              (y.isBlockBoundary && y.isBlockBoundary ({br: 1})) ||
              ((r = u.getLast (CKEDITOR.dom.walker.whitespaces (!0))), !r ||
                (r.is && r.is ('br')) ||
                u.append ('br')), l.moveChildren (u)), f
            ? l.remove ()
            : l.setHtml (''));
        r = t;
      }
    ...
    function C (d, f) {
      ...
      if (1 < g) {
        ...
        for (
          (g = m = 1), (e = c.clone ()), e.insertAfter (c), e.append (
            (c = b.clone ())
          ), (l = A (h, a)), (k = 0);
          k < l.length;
          k++
          ...
          d.addMenuItems ({
            tablecell: {
              ...
              getItems: function () {
                ...
                d.filter.check (h) &&
                  (a.tablecell_properties = 0 < b.length
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED);
                return a;
              },
  ...
  (function () {
    function D (a) {
      ...
      function f () {
        var b = {}, c, e, g;
        for (c in a.ui.items)
          (e = a.ui.items[c]), (g = e.toolbar || 'others'), (g = g.split (
            ','
          )), (e = g[0]), (g = parseInt (g[1] || -1, 10)), b[e] ||
            (b[e] = []), b[e].push ({name: c, order: g});
        for (e in b)
        ...
        for (e = 0; e < b.length; ++e)
          (d = b[e]), (h = {}), '/' == d
            ...
            : CKEDITOR.tools.isArray (d)
                ...
                : d.items &&
                    (c (h, CKEDITOR.tools.clone (d.items)), (h.name =
                      d.name), a.push (h));
        return a;
      }
    ...
    var E = {
      ...
      exec: function (a) {
        a.toolbox &&
          ((a.toolbox.focusCommandExecuted = !0), CKEDITOR.env.ie ||
            CKEDITOR.env.air
            ? setTimeout (function () {
                a.toolbox.focus ();
              }, 100)
                  ...
                  if (
                    ((b = 9 == h
                      ...
                      : (b ? b.previous : c.toolbar.previous) ||
                          a.toolbox.toolbars[a.toolbox.toolbars.length - 1]), b
                      .items.length)
                  )
                    for (
          ...
          if (this.toolbox) {
            ...
            for (a = this.toolbox.toolbars; d < a.length; d++)
              for ((e = a[d].items), (b = 0); b < e.length; b++)
                (f = e[b]), f.clickFn &&
                  CKEDITOR.tools.removeFunction (f.clickFn), f.keyDownFn &&
      ...
      onKeydown: function (a) {
        ...
        if (229 !== b)
          if (-1 < CKEDITOR.tools.indexOf (g, a.data.getKeystroke ()))
            ...
            (this.keyEventsStack.cleanUp (a), (a = this
              .undoManager), this.keyEventsStack.getLast (b) ||
  ...
  (function () {
    function m (a) {
      ...
      if (b && !b.isDetached ()) {
        ...
        d.contentEditable = !0;
        CKEDITOR.env.ie &&
          ((d.hideFocus = !0), (d.disabled = !0), d.removeAttribute (
            'disabled'
          ));
          ...
          d &&
            (c &&
              (c.detachEvent (
                'onresizestart',
                b
              ), (c = null)), d.$.attachEvent ('onresizestart', b), (c = d.$));
        });
      }
      function b (a) {
        a.returnValue = !1;
        ...
        a.addMode ('wysiwyg', function (e) {
          function b (b) {
            ...
            a.isDestroyed () ||
              a.isDetached () ||
              (a.editable (
                new l (a, d.$.contentWindow.document.body)
          ...
          g &&
            (CKEDITOR.env.ie && h && (g += ', ' + h), d.setAttribute (
              'title',
              g
            ));
          if (h) {
      ...
      proto: {
        setData: function (a, e) {
          ...
          if (e)
            ...
            d
              ? (/<body[\s|>]/.test (a) ||
                  (a = '\x3cbody\x3e' + a), /<html[\s|>]/.test (a) ||
                  (a =
                    '\x3chtml\x3e' + a + '\x3c/html\x3e'), /<head[\s|>]/.test (
                  a
                )
                  ? /<title[\s|>]/.test (a) ||
                      (a = a.replace (
                  ...
                  (a = a.replace (
                    /<head[^>]*?>/,
                    '$\x26' + h
                  )), (a = a.replace (/<\/head\s*>/, g + '$\x26')), (a = f + a))
              : (a =
                  c.docType +
                  '\x3chtml dir\x3d"' +
        ...
        detach: function () {
          ...
          a &&
            (a.clearCustomData (), (e = a.removeCustomData ('onResize')) &&
  ...
  CKEDITOR.config.plugins =
    'basicstyles,blockquote,button,panelbutton,panel,floatpanel,colorbutton,dialogui,dialog,colordialog,menu,contextmenu,entities,popup,filetools,filebrowser,listblock,richcombo,font,format,horizontalrule,image,indent,indentlist,justify,fakeobjects,link,list,liststyle,magicline,maximize,removeformat,resize,smiley,specialchar,tab,table,tabletools,toolbar,undo,wysiwygarea';
  ...
  (function () {
    ...
    if (CKEDITOR.env.hidpi)
      setIcons (
        'bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,bgcolor,168,,textcolor,192,,horizontalrule,216,,image,240,,indent-rtl,264,,indent,288,,outdent-rtl,312,,outdent,336,,justifyblock,360,,justifycenter,384,,justifyleft,408,,justifyright,432,,anchor-rtl,456,,anchor,480,,link,504,,unlink,528,,bulletedlist-rtl,552,,bulletedlist,576,,numberedlist-rtl,600,,numberedlist,624,,maximize,648,,removeformat,672,,smiley,696,,specialchar,720,,table,744,,redo-rtl,768,,redo,792,,undo-rtl,816,,undo,840,',
        'icons_hidpi.png'
      );
    else
      setIcons (
        'bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,bgcolor,168,auto,textcolor,192,auto,horizontalrule,216,auto,image,240,auto,indent-rtl,264,auto,indent,288,auto,outdent-rtl,312,auto,outdent,336,auto,justifyblock,360,auto,justifycenter,384,auto,justifyleft,408,auto,justifyright,432,auto,anchor-rtl,456,auto,anchor,480,auto,link,504,auto,unlink,528,auto,bulletedlist-rtl,552,auto,bulletedlist,576,auto,numberedlist-rtl,600,auto,numberedlist,624,auto,maximize,648,auto,removeformat,672,auto,smiley,696,auto,specialchar,720,auto,table,744,auto,redo-rtl,768,auto,redo,792,auto,undo-rtl,816,auto,undo,840,auto',
        'icons.png'
      );
  }) ();
