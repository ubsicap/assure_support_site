...
return array(
    ...
    'unconfirmed_email_exists' => 'An account already exists with that email address, but has not yet been verified. If it is not verified soon, it will be deleted and you will be able to register with this email. Please try again in ^ minute(s).',
);
