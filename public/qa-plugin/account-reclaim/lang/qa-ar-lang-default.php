...
return array(
    ...
    'archived_warning' => "This email address is used on support.paratext.org.<br><br>If you would like to keep your history from this account, <b><a style='color:inherit' href='https://staging.support.bible/index.php/recover-account' rel='noopener noreferrer'>reclaim your support.paratext.org account</a></b>.<br><br>You will permanently lose acccess to your history from your support.paratext.org account if you continue and create a new account. To lose your support.paratext.org history, you must type the following in the box below: <b>^</b>",
