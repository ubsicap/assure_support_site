...
return array(
    ...
    'recover_page_description' => "The Paratext Support Forum (support.paratext.org) was a secure forum. However, anyone can view all posts on SITE_NAME without a login. Many of the posts and comments from the Paratext Support Forum have been moved to SITE_NAME. To protect your security, we have removed names from all posts and comments. On SITE_NAME, it is possible to reclaim your support.paratext.org account and retain access to your posts, comments, and badges—or to start afresh with a new account.<br><br><b>To reclaim your history of posts, comments and badges from support.paratext.org</b>, you will need to enter the email address that you used with your support.paratext.org account in the box below. We will send you a confirmation email describing the next steps. You will have the option to either remain anonymous or to specify an identifiable user name according to your security needs.<br><br>If you do not wish to reclaim your history of posts, comments and badges, you may do so by clicking <a href='https://staging.support.bible/register' rel='noopener noreferrer'>create an account</a>. Your original posts will still be visible on SITE_NAME but they will not be associated with your name or email address and you will not be able to modify them.<br><b>NOTE:</b> If you create an account using the same email address that you used with your support.paratext.org account rather than reclaiming an account, you will lose access to the history from your support.paratext.org account.<hr>",
