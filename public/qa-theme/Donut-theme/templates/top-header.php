<?php
// Don't display the headers if the user is logged in
$header_left_text = qa_is_logged_in() ? null : qa_opt('donut_top_bar_left_text');
$header_right_text = qa_is_logged_in() ? null : qa_opt('donut_top_bar_right_text');
